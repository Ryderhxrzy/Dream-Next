...
export type UsernameChangeRequestStatus =
  ...
  | "approved"
  | "rejected"
export type WebstoreRequestStatus =
  | "pending_review"
  | "approved"
  | "rejected"
  | "deleted"
...
export const adminInquiriesApi = baseApi.injectEndpoints({
  ...
  endpoints: (builder) => ({
    getUsernameChangeRequests: builder.query<
    ...
    approveUsernameChange: builder.mutation<
      { message: string },
      { id: number }
    >({
      query: ({ id }) => ({
    ...
    getPartnerWebstoreRequests: builder.query<
      PartnerWebstoreRequestsResponse,
      void
    >({
      query: () => ({
    ...
    approveWebstoreRequest: builder.mutation<
      { message: string },
      { id: number }
    >({
      query: ({ id }) => ({
    ...
    approveWebstoreReceipt: builder.mutation<
      { message: string },
    ...
    rejectWebstoreReceipt: builder.mutation<
      { message: string },
      { id: number; detailId: number }
    >({
      query: ({ id, detailId }) => ({
    ...
    rejectWebstoreRequest: builder.mutation<
      { message: string },
      { id: number }
    >({
      query: ({ id }) => ({
    ...
    deleteWebstoreRequest: builder.mutation<
      { message: string },
      { id: number }
    >({
      query: ({ id }) => ({
    ...
    deletePartnerWebstoreRequest: builder.mutation<
      { message: string },
      { id: number }
    >({
      query: ({ id }) => ({
    ...
    deletePartnerWebstoreReceiptItem: builder.mutation<
      { message: string },
      { id: number }
    >({
      query: ({ id }) => ({
    ...
    uploadPartnerWebstoreReceipt: builder.mutation<
      { message: string; url: string; public_id: string },
      FormData
    >({
      query: (body) => ({
