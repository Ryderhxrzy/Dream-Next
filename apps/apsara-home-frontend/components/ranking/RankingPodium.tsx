...
const CROWN_SVG = (
  ...
  >
    <svg width="48" height="38" viewBox="0 0 48 38" fill="none">
      <path
        d="M5 30h38l5-22-13 11L24 3 18 19 5 8z"
        fill="#FBBF24"
        stroke="#1E293B"
        strokeWidth="2"
          ...
          <div className="flex flex-col items-center">
            ...
            <motion.div
              ...
              style={{
                ...
                borderColor: "#1E293B",
                boxShadow: `3px 3px 0px ${style.shadowColor}`,
              }}
            >
    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-3 sm:items-end">
        {ordered.map((earner, index) => {
          ...
          const rank = (earner === top3[0] ? 1 : earner === top3[1] ? 2 : 3) as
            | 1
            | 2
            | 3
          return (
