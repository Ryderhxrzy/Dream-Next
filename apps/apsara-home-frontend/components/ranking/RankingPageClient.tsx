      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-12 lg:py-12">
        ...
        >
          <div>
            ...
            >
              <path
                d="M0 5 Q22 0 45 5 Q68 10 90 5 Q112 0 135 5 Q158 10 180 5"
                stroke="#F472B6"
                strokeWidth="3"
                fill="none"
                strokeLinecap="round"
        ...
        >
          ...
          >
            <div
              ...
              style={{ borderColor: "#1E293B", backgroundColor: "#FBBF2420" }}
            >
              <svg
                className="h-6 w-6"
                fill="none"
          ...
          >
            <div
              className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border-2"
              style={{ borderColor: "#1E293B", backgroundColor: "#8B5CF620" }}
            >
              <svg
                className="h-6 w-6"
                fill="none"
          ...
          >
            <div
              className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border-2"
              style={{ borderColor: "#1E293B", backgroundColor: "#34D39920" }}
            >
              <svg
                className="h-6 w-6"
                fill="none"
          ...
          >
            <div
              className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border-2"
              style={{ borderColor: "#1E293B", backgroundColor: "#F472B620" }}
            >
              <svg
                className="h-6 w-6"
                fill="none"
