      ...
      <div className="animate-fade-up-in relative overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-950">
        ...
        <div className="pointer-events-none absolute right-6 top-1/2 -translate-y-1/2 select-none">
          <div className="relative h-40 w-44">
            ...
            {/* bottom-left small */}
            <svg
              className="absolute bottom-3 left-3 h-3 w-3 text-indigo-200"
              fill="none"
              stroke="currentColor"
              strokeWidth="2.5"
              viewBox="0 0 24 24"
            ...
            <div
              ...
              style={{
                ...
                height: 62,
                background:
                  "linear-gradient(160deg, #c4b5fd 0%, #a78bfa 60%, #8b5cf6 100%)",
              }}
            />
            ...
            <div
              ...
              style={{
                ...
                animationDelay: "0s",
                boxShadow:
                  "0 8px 32px rgba(99,102,241,0.18), 0 2px 8px rgba(99,102,241,0.10)",
              }}
            >
              <svg
            ...
            <div
              ...
              style={{
                ...
                animationDelay: "0.7s",
                boxShadow:
                  "0 8px 24px rgba(99,102,241,0.15), 0 2px 6px rgba(99,102,241,0.08)",
              }}
            >
              <svg
          ...
          {filtered.map((category, index) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div
                  className={`flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl ${color.icon}`}
                >
                ...
                {/* Chevron */}
                <div
                  className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full ${color.chevron}`}
                >
                  <svg
                    className="h-4 w-4"
                    fill="none"
