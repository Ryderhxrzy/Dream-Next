    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="relative overflow-hidden rounded-2xl p-5 bg-gradient-to-br from-slate-700 to-slate-900 dark:from-slate-800 dark:to-slate-950 text-white">
          ...
          <span className="absolute bottom-3 right-4 text-3xl opacity-20 select-none">
            ₱
          </span>
        </div>
        <div className="relative overflow-hidden rounded-2xl p-5 bg-gradient-to-br from-amber-500 to-orange-600 dark:from-amber-600 dark:to-orange-700 text-white">
          ...
          />
          <p className="text-[10px] uppercase tracking-widest text-amber-100 font-semibold">
            Pending Requests
          </p>
          <p className="mt-2 text-2xl font-black tracking-tight">
            {summary.pending}
        ...
        <div className="relative overflow-hidden rounded-2xl p-5 bg-gradient-to-br from-emerald-500 to-teal-600 dark:from-emerald-600 dark:to-teal-700 text-white">
          ...
          />
          <p className="text-[10px] uppercase tracking-widest text-emerald-100 font-semibold">
            Total Released
          </p>
          <p className="mt-2 text-2xl font-black tracking-tight">
      ...
      {isCustomerSession && policy && eligibility && (
        <div className="rounded-2xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-gray-800 overflow-hidden">
          ...
          <div className="p-5 space-y-4">
            <div>
              <p className="text-[10px] uppercase tracking-widest font-bold text-gray-400 dark:text-gray-500 mb-2">
                Policy
              </p>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                {[
                  ...
                  <div
                    key={label}
                    className="rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-slate-700 px-3 py-2.5"
                  >
                    <p className="text-[10px] uppercase tracking-wide text-gray-400 dark:text-gray-500">
                      {label}
                    </p>
                    <p className="mt-0.5 font-semibold text-gray-800 dark:text-gray-200 text-xs">
                      {value}
                    </p>
                  </div>
                ))}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                <div className="rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-slate-700 px-3 py-2.5">
                  ...
                  <p className="mt-0.5 font-bold text-gray-800 dark:text-gray-100 text-sm">
                ...
                <div className="rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-slate-700 px-3 py-2.5">
                  ...
                  <div className="mt-0.5 flex items-center gap-1.5">
                    <span
                      className={`inline-block h-2 w-2 rounded-full shrink-0 ${eligibility.has_active_account ? "bg-emerald-500" : "bg-red-500"}`}
                    />
                    <p
                      className={`font-bold text-sm ${eligibility.has_active_account ? "text-emerald-700 dark:text-emerald-400" : "text-red-700 dark:text-red-400"}`}
                    >
            ...
            <div
              className={`flex items-center gap-3 rounded-xl px-4 py-3 border ${eligibility.eligible ? "bg-emerald-50 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-800" : "bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800"}`}
            >
              <span
                className={`text-lg shrink-0 ${eligibility.eligible ? "text-emerald-500" : "text-red-500"}`}
              >
        ...
        !canSubmitVerification && (
          <div className="rounded-2xl border border-sky-200 dark:border-sky-800 bg-gradient-to-br from-sky-50 to-blue-50 dark:from-sky-900/20 dark:to-blue-900/20 p-5">
            <div className="flex items-start gap-4">
              <div className="shrink-0 h-10 w-10 rounded-full bg-sky-600 dark:bg-sky-700 text-white flex items-center justify-center font-bold text-base">
                i
              </div>
              <div>
      ...
      {isCustomerSession && canSubmitVerification && !isVerificationPending && (
        <motion.div
          ...
          className={`scroll-mt-28 rounded-2xl border bg-sky-50 dark:bg-sky-900/20 overflow-hidden transition-all duration-500 ${
            isVerificationSpotlightActive
              ? "border-sky-400 dark:border-sky-700 ring-4 ring-sky-200/70 dark:ring-sky-900/50"
        ...
        >
          ...
          <div className="p-5 space-y-5">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-sky-600 dark:text-sky-500 mb-3">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="inline-flex items-center rounded-full bg-blue-100 dark:bg-blue-900/50 border border-blue-200 dark:border-blue-700 px-2.5 py-0.5 text-[10px] font-bold text-blue-700 dark:text-blue-400 uppercase tracking-wide">
                  Pending Review
                </span>
              </div>
              ...
              <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-2 text-xs">
                {[
                  ...
                  <div
                    key={label}
                    className="rounded-lg bg-white/60 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 px-2.5 py-2"
                  >
      ...
      {isCustomerSession &&
        (isEligibleByPolicy || shouldUseCombinedVerificationFlow) && (
          <form
            ...
            className="scroll-mt-28 rounded-2xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-gray-800 overflow-hidden"
          >
            <div className="px-5 py-4 border-b border-gray-100 dark:border-slate-700 bg-gray-50 dark:bg-gray-800/80 flex items-center gap-2.5">
              <svg
                className="w-5 h-5 text-gray-500 dark:text-gray-400 shrink-0"
                ...
                <tbody className="divide-y divide-gray-50 dark:divide-slate-700/50">
                  {rows.map((row) => (
                    ...
                    >
                      ...
                      <td className="py-3 pr-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">
                        {row.channel}
                      </td>
                      <td className="py-3 pr-4">
                        <span
                          className={`inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-semibold capitalize ${statusStyle[row.status] || "bg-gray-50 dark:bg-gray-700/30 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-slate-700"}`}
                        >
