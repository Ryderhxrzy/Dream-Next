          ...
          >
            ...
            {isAuthenticated && !isError && items.length > 0 && (
              <div className="mt-6 relative max-w-sm">
                <svg
                  className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400 dark:text-gray-500 pointer-events-none"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                ...
                {search && (
                  <button
                    onClick={() => setSearch("")}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-gray-500 hover:text-slate-600 dark:hover:text-gray-400"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="14"
          ...
          {isLoading ? (
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
              {Array.from({ length: 8 }).map((_, i) => (
                <div
                  key={i}
                  className="rounded-2xl border border-slate-100 dark:border-slate-700 bg-white dark:bg-gray-800 overflow-hidden animate-pulse"
                >
            ...
            >
              ...
              <p className="mt-1.5 text-sm text-slate-500 dark:text-gray-400 max-w-xs">
            ...
            >
              ...
              <p className="text-sm font-semibold text-red-700 dark:text-red-400 max-w-sm">
                {errorMessage}
              </p>
              <button
                onClick={() => refetch()}
            ...
            >
              ...
              <div className="mt-6 flex items-center gap-2">
                ...
                <Link
                  ...
                  className="rounded-2xl bg-sky-500 dark:bg-sky-600 px-6 py-2.5 text-sm font-semibold text-white hover:bg-sky-600 dark:hover:bg-sky-700 transition-colors"
                >
                  Browse Shop
                </Link>
              </div>
