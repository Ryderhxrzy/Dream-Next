            ...
            <div className="flex gap-3">
              {["F", "I", "T"].map((s, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-9 h-9 bg-white/10 hover:bg-orange-500 rounded-xl flex items-center justify-center text-xs font-bold transition-all duration-200"
                >
                  {s}
                </a>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {["Visa", "Mastercard", "GCash", "Maya", "COD"].map((p) => (
                <span
                  key={p}
                  className="bg-white/10 text-white/60 text-xs px-2.5 py-1 rounded-lg"
                >
                  {p}
                </span>
              ))}
