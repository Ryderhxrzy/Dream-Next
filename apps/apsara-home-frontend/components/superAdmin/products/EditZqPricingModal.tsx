                              ...
                              <table className="min-w-full text-xs">
                                <thead className="bg-slate-50">
                                  <tr className="border-b border-slate-200">
                                    ...
                                    <th className="px-3 py-2.5 text-[11px] font-semibold uppercase tracking-wide text-emerald-600 bg-emerald-50/60">
                                      Member (₱)
                                    </th>
                                    <th className="px-3 py-2.5 text-[11px] font-semibold uppercase tracking-wide text-emerald-600 bg-emerald-50/60">
                                      Dealer (₱)
                                    ...
                                    <th className="px-3 py-2.5 text-center text-[11px] font-semibold uppercase tracking-wide text-teal-600 bg-teal-50/60">
                                      Auto PV
                                    </th>
                                  </tr>
                                </thead>
