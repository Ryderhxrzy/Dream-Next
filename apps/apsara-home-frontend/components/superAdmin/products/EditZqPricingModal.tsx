...
export default function EditZqPricingModal({
  product,
  onClose,
  onSaved,
                  ...
                  {!isFetchingDetail && (
                    <>
                      ...
                      <p className="text-[11px] text-slate-400">
                        Applied to the product as a whole. Variant-specific
                        overrides can be set below.
                      </p>
                      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                        <Field label="PV Pricing Tier">
                          <div className="space-y-1">
                            <select
                              value={form.pv_tier}
                              onChange={(e) => set("pv_tier", e.target.value)}
                              className={inputCls()}
                            >
                        ...
                        <Field label="PV Product">
                          <div className="space-y-1">
                            ...
                            />
                            <p className="text-[11px] text-slate-500">
                              Leave blank to use auto-computed PV.
                            </p>
                          </div>
                        </Field>
                        <Field label="Reversed PV Multiplier">
                          <div className="space-y-1">
                            <input
                              ...
                              onChange={(e) =>
                                set("reversed_pv_multiplier", e.target.value)
                              }
                              placeholder="e.g. 0.3"
                              className={inputCls()}
                            />
                      ...
                      {detail && detail.specs.length > 0 && (
                        <>
                          ...
                          <p className="text-[11px] text-slate-400">
                            ...
                            inherit the product-level pricing above. Auto PV =
                            Dealer Price × Multiplier.
                          </p>
                          <div className="overflow-hidden rounded-2xl border border-slate-200">
                              ...
                              <table className="min-w-full text-xs">
                                <thead className="bg-slate-50">
                                  <tr className="border-b border-slate-200">
                                    <th className="px-3 py-2.5 text-left text-[11px] font-semibold tracking-wide text-slate-500 uppercase">
                                      Image
                                    </th>
                                    <th className="px-3 py-2.5 text-left text-[11px] font-semibold tracking-wide text-slate-500 uppercase">
                                      Spec
                                    ...
                                    <th className="px-3 py-2.5 text-right text-[11px] font-semibold tracking-wide text-slate-500 uppercase">
                                      AF HOME GLOBAL Cost
                                    </th>
                                    <th className="px-3 py-2.5 text-right text-[11px] font-semibold tracking-wide text-slate-500 uppercase">
                                      AF HOME GLOBAL Price
                                    </th>
                                    <th className="px-3 py-2.5 text-right text-[11px] font-semibold tracking-wide text-slate-500 uppercase">
                                      Stock
                                    </th>
                                    <th className="bg-emerald-50/60 px-3 py-2.5 text-[11px] font-semibold tracking-wide text-emerald-600 uppercase">
                                      Member (₱)
                                    </th>
                                    <th className="bg-emerald-50/60 px-3 py-2.5 text-[11px] font-semibold tracking-wide text-emerald-600 uppercase">
                                      Dealer (₱)
                                    ...
                                    <th className="bg-teal-50/60 px-3 py-2.5 text-center text-[11px] font-semibold tracking-wide text-teal-600 uppercase">
                                      Auto PV
                                    </th>
                                  </tr>
                                </thead>
                                      ...
                                      >
                                        <td className="px-3 py-2.5">
                                          {spec.image ? (
                                            ...
                                            <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200 bg-slate-100 text-[10px] text-slate-400">
                                              —
                                            </div>
                                          )}
                                        </td>
                                        <td className="max-w-[120px] px-3 py-2.5 font-medium text-slate-800">
                                        ...
                                        {/* editable pricing */}
                                        <td className="min-w-[90px] bg-emerald-50/40 px-2 py-2">
                                          <input
                                            type="number"
                                            min="0"
                                            step="0.01"
                                        ...
                                        <td className="min-w-[80px] bg-emerald-50/40 px-2 py-2">
                                          <input
                                            type="number"
                                            min="0"
                                            step="0.01"
                                        ...
                                        <td className="bg-teal-50/40 px-3 py-2.5 text-center">
                            ...
                            <div className="border-t border-slate-100 bg-slate-50 px-4 py-2">
                              <p className="text-[11px] text-slate-400">
                                ...
                                are editable. Leave blank to inherit
                                product-level pricing.
                              </p>
                            </div>
                          </div>
  ...
  return (
    <div className="flex items-center justify-between gap-2 px-3 py-2.5">
      <div className="min-w-0">
        ...
        <div className="mt-0.5 flex flex-wrap items-center gap-1 font-mono text-[11px] text-slate-400">
          <span>{a}</span>
      ...
      <div className="flex items-center justify-between bg-gradient-to-r from-blue-600 to-blue-500 px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-blue-200">
            — live computation (product level)
          </span>
        </div>
