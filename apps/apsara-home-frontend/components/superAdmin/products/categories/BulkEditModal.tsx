...
export default function BulkEditModal({ categories, onClose }: Props) {
  ...
  const handleSaveAll = async () => {
    ...
    if (!hasError) {
      ...
      setServerError(
        "Some categories failed to save. Check the rows marked in red."
      )
    }
  }
                    ...
                    return (
                      ...
                      >
                        ...
                        <input
                          ...
                          value={row.cat_name}
                          onChange={(e) =>
                            updateRow(row.id, "cat_name", e.target.value)
                          }
                          maxLength={50}
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            value={row.cat_url}
                            onChange={(e) =>
                              handleUrlChange(row.id, e.target.value)
                            }
                            maxLength={40}
                            disabled={status === "saving"}
                        ...
                        <input
                          ...
                          value={row.cat_order}
                          onChange={(e) =>
                            updateRow(row.id, "cat_order", e.target.value)
                          }
                          min="0"
                          disabled={status === "saving"}
