              ...
              >
                ...
                <div className="space-y-5 px-6 py-5">
                  ...
                  <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-700">
                    Only the fields you change here will be applied. Leaving a
                    field as <span className="font-semibold">No change</span>{" "}
                    keeps the current value of each selected product.
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between border-t border-slate-100 px-6 py-4">
                  <p className="text-xs text-slate-400">
                    {patchKeys.length > 0
                      ? `${patchKeys.length} field${patchKeys.length !== 1 ? "s" : ""} ready to apply`
