...
function buildProductDescription(
  ...
  const assemblySentence =
    typeof input.assemblyRequired === "boolean"
  ...
  const notesSentence = notes ? `Key selling note: ${notes}.` : ""
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <h3 className="mt-1 text-sm font-bold text-slate-900">
            Generate product description from form details
          </h3>
          <p className="mt-1 text-xs text-slate-500">
            Free template-based generator. Uses the current product name,
            category, room, material, dimensions, and notes.
          </p>
        </div>
        <button
          type="button"
