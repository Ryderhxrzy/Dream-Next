...
export default function AssemblyGuidesManager() {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      showErrorToast(
        apiErr?.data?.message || "Failed to delete assembly guide."
      )
    }
  }
    ...
    <div className="space-y-6 dark:bg-slate-950 dark:text-slate-100">
        ...
        <div className="grid gap-6 px-6 py-7 lg:grid-cols-[1.3fr_0.7fr] lg:px-8">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-black tracking-tight text-slate-900 dark:text-slate-100">
              Assembly Guides Manager
            </h1>
            <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600 dark:text-slate-300">
              Add direct PDF guides for the public Assembly Guides page. Keep
              the form simple: title, PDF link, optional cover image, then
              publish.
            </p>
          </div>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
        <form
          ...
          className="rounded-[1.75rem] border border-slate-100 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900"
        >
          ...
          <div className="mt-5 space-y-4">
            ...
            <Field label="PDF URL">
              <div className="space-y-3">
                ...
                <div className="flex flex-col gap-3 rounded-[1.5rem] border border-slate-200 bg-slate-50/70 p-4 sm:flex-row sm:items-center sm:justify-between dark:border-slate-700 dark:bg-slate-800/80">
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-slate-500">
                      Upload a PDF here and we will automatically fill and lock
                      the PDF URL for you.
                    </p>
                  </div>
                ...
                <input
                  ...
                  placeholder={
                    useManualPdfLink
                      ? "Google Drive link will appear here"
                      : "Upload a PDF to generate the link"
                  }
              ...
              <div className="space-y-3">
                <div className="flex flex-col gap-3 rounded-[1.5rem] border border-slate-200 bg-slate-50/70 p-4 sm:flex-row sm:items-center sm:justify-between dark:border-slate-700 dark:bg-slate-800/80">
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-slate-500">
                      Upload an optional preview image and we will auto-fill and
                      lock the cover URL.
                    </p>
                  </div>
                  <div className="flex items-center gap-3">
            ...
            <div className="rounded-2xl border border-cyan-100 bg-cyan-50/70 px-4 py-3 text-sm text-cyan-800 dark:border-cyan-900/30 dark:bg-cyan-950/20 dark:text-cyan-200">
              Tip: the PDF URL is auto-generated from the attached file and
              stays locked to avoid accidental edits. If you need a different
              file, just attach a new PDF or switch to a Google Drive link.
            </div>
          </div>
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm font-semibold text-slate-900 dark:text-slate-100">
                  Recently Assembly Guides Uploaded
                </p>
              </div>
            </div>
