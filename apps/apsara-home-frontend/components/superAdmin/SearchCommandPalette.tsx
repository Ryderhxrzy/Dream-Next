...
const ADMIN_PAGES: Page[] = [
  ...
  { title: "Chat", href: "/admin/chat", breadcrumbs: ["Admin", "Chat"] },
  {
    title: "All Members",
    href: "/admin/members",
    breadcrumbs: ["Admin", "Members"],
  },
  { title: "Orders", href: "/admin/orders", breadcrumbs: ["Admin", "Orders"] },
  {
    title: "Interior Requests",
    href: "/admin/interior-requests",
    breadcrumbs: ["Admin", "Interior Requests"],
  },
  {
    title: "Accounting Dashboard",
    href: "/admin/accounting",
    breadcrumbs: ["Admin", "Accounting"],
  },
  {
    title: "Products",
    href: "/admin/products",
  ...
  },
  {
    title: "Inquiry",
    href: "/admin/inquiry",
    breadcrumbs: ["Admin", "Inquiry"],
  },
  {
    title: "Project",
    href: "/admin/project",
    breadcrumbs: ["Admin", "Project"],
  },
  {
    title: "Shop Builder",
    href: "/admin/webpages/shop-builder",
    breadcrumbs: ["Admin", "Web Content", "Shop Builder"],
  },
  ...
  },
  {
    ...
    breadcrumbs: ["Admin", "Settings", "General"],
  },
  {
    title: "Profile",
    href: "/admin/profile",
                ...
                <input
                  ...
                  onKeyDown={(event) => {
                    if (event.key === "ArrowDown" && filteredPages.length > 0) {
                      ...
                      setSelectedIndex(
                        (prev) => (prev + 1) % filteredPages.length
                      )
                    }
              ...
              {search.trim().length === 0 ? (
                <div className="px-4 py-8 text-center">
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Start typing to search admin pages.
                  </p>
                </div>
                  ...
                  {filteredPages.map((page, index) => (
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        <p
                          className={`text-sm font-medium ${index === selectedIndex ? "text-sky-700 dark:text-sky-300" : "text-gray-800 dark:text-gray-100"}`}
                        >
                          {page.title}
                        </p>
