  ...
  const cards = [
    {
      ...
      val: "text-slate-800 dark:text-white",
    ...
    },
    {
      ...
      val: "text-emerald-700 dark:text-emerald-200",
    ...
    },
    {
      ...
      val: "text-sky-700 dark:text-sky-200",
    ...
    },
    {
      ...
      val: "text-red-700 dark:text-red-200",
    ...
    },
    {
      ...
      val: "text-teal-700 dark:text-teal-200",
    ...
    },
    {
      ...
      val: "text-cyan-700 dark:text-cyan-200",
    ...
    },
    {
      ...
      val: "text-indigo-700 dark:text-indigo-200",
        ...
        {cards.map((card, index) => {
          const inner = (
            <div className="flex h-full flex-col">
              <div
                className={`mb-3.5 flex h-11 w-11 items-center justify-center rounded-xl bg-linear-to-br ${cardGradients[card.key]} text-white shadow-sm ring-1 ring-white/20 transition-transform duration-300 group-hover:scale-105`}
              >
                {card.icon}
              </div>
          ...
          return (
            ...
            >
              <Card
                className={`group h-full rounded-2xl border ${card.border} bg-white shadow-sm ring-1 ring-slate-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-md dark:bg-slate-900/95 dark:ring-slate-800 dark:hover:bg-slate-900`}
              >
