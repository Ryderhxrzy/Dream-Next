...
const registrationOptions: DataFilterOption<
...
const profilePhotoOptions: DataFilterOption<
...
const sortOptions: DataFilterOption<
  | "default"
  | "newest_registered"
  | "oldest_registered"
  | "earnings_low_high"
    ...
    <DataFilterBar
      ...
      filters={[
        ...
        },
        {
          ...
          onChange: (value) =>
            onRegistration(value as "all" | "new" | "referred" | "direct"),
        },
        {
          key: "profilePhoto",
          ...
          onChange: (value) =>
            onProfilePhoto(value as "all" | "with_photo" | "no_photo"),
        },
        {
          key: "sort",
      ...
      summaryLeft={
        <p>
          ...
          {hasFilter ? (
            <span className="ml-1 text-teal-600">filtered</span>
          ) : null}
        </p>
      }
      summaryRight={
        <p className="text-slate-400 dark:text-slate-300">
          Filters and export now follow the same Hero UI controls used in
          products.
        </p>
      }
    />
