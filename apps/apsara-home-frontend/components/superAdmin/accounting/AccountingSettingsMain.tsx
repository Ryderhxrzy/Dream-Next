...
function SettingField({
  ...
  return (
    <div className="flex flex-col gap-1.5 border-b border-slate-100 py-4 last:border-0 sm:flex-row sm:items-start sm:justify-between sm:gap-8 dark:border-slate-800">
...
function Toggle({
  ...
  return (
    <button
      ...
      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none ${
...
export default function AccountingSettingsMain() {
  ...
  const inputCls =
    "w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 text-sm text-slate-700 dark:text-slate-200 outline-none transition-all focus:border-sky-400 dark:focus:border-sky-500 focus:ring-1 focus:ring-sky-400/30"
  ...
  return (
    <div className="space-y-5">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <div className="mb-2 flex flex-wrap items-center gap-2">
                ...
                <span className="rounded-full border border-amber-400/30 bg-amber-400/15 px-2.5 py-1 text-[10px] font-semibold text-amber-300">
                  Admin Only
                </span>
              </div>
              ...
              <p className="mt-0.5 text-sm text-slate-400">
                Configure payout thresholds, approval policies, and workflow
                preferences
              </p>
            </div>
            <button
              type="button"
              onClick={handleSave}
              className={`inline-flex shrink-0 items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-bold transition-all ${
                saved
                ...
                <>
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M17 16v2a2 2 0 01-2 2H5a2 2 0 01-2-2v-2M15 8l-3-3m0 0L9 8m3-3v12"
                    />
                  </svg>
                  Save Changes
                </>
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700/60 dark:bg-slate-900">
        ...
        <div className="px-5">
          <SettingField
            ...
            description="Requests below this amount will be automatically rejected."
          >
          ...
          <SettingField
            ...
            description="Requests exceeding this amount require additional review before approval."
          >
            <div className="relative">
              <span className="absolute top-1/2 left-3 -translate-y-1/2 text-sm font-bold text-slate-400">
                ₱
          ...
          <SettingField
            label="Auto-hold Large Payouts"
            description="Automatically place on hold any request exceeding the threshold below."
          >
            <Toggle
              checked={autoHoldLarge}
              onChange={setAutoHoldLarge}
              label="Auto-hold large payouts"
            />
          </SettingField>
          {autoHoldLarge && (
            <SettingField
              ...
              description="Requests above this amount are automatically placed on hold."
            >
              <div className="relative">
                <span className="absolute top-1/2 left-3 -translate-y-1/2 text-sm font-bold text-slate-400">
                  ₱
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700/60 dark:bg-slate-900">
        ...
        <div className="px-5">
          <SettingField
            ...
            description="All requests must be approved by two separate admin accounts before releasing."
          >
            <Toggle
          ...
          <SettingField
            ...
            description="A valid invoice number must be assigned before a payout can be released."
          >
            <Toggle
          ...
          <SettingField
            ...
            description="SLA target for approving a pending request. Used for queue aging alerts."
          >
            <input
              type="number"
          ...
          <SettingField
            label="Release Deadline (hours)"
            description="SLA target for releasing an approved payout after it enters the release queue."
          >
            <input
              type="number"
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700/60 dark:bg-slate-900">
        ...
        <div className="px-5">
          <SettingField
            label="Notify on Payout Release"
            description="Send email notification to the affiliate when their payout is released."
          >
            <Toggle
              checked={notifyOnRelease}
              onChange={setNotifyOnRelease}
              label="Notify on release"
            />
          </SettingField>
          <SettingField
            label="Notify on Rejection"
            description="Send email notification when a payout request is rejected."
          >
            <Toggle
          ...
          <SettingField
            label="Notify on Hold"
            description="Send email notification when a request is placed on hold for review."
          >
            <Toggle
      ...
      {/* ── Danger Zone ── */}
      <div className="overflow-hidden rounded-2xl border border-red-200 bg-white shadow-sm dark:border-red-500/30 dark:bg-slate-900">
        <div className="flex items-center gap-2.5 border-b border-red-100 bg-red-50/50 px-4 py-3 dark:border-red-500/20 dark:bg-red-500/5">
          ...
          <h2 className="text-xs font-bold tracking-wide text-red-600 uppercase dark:text-red-400">
            Danger Zone
          </h2>
        </div>
        <div className="flex items-center justify-between gap-4 px-5 py-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-slate-400 dark:text-slate-500">
              Restore all accounting settings to their factory defaults. This
              action cannot be undone.
            </p>
          </div>
          <button
            type="button"
            className="shrink-0 rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-xs font-semibold text-red-700 transition-colors hover:bg-red-100 dark:border-red-500/30 dark:bg-red-500/10 dark:text-red-400 dark:hover:bg-red-500/20"
          >
            Reset to Defaults
          </button>
        </div>
