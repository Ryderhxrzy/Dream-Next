...
const STEP_META: Partial<Record<Step, StepMeta>> = {
  step1: {
    ...
    caption:
      "Fill in your slug (store URL), display name, hero title, and notification email — the foundation of your branded storefront.",
  },
  step2: {
    label: "Step 2 of 5",
    title: "Upload logo & add referral link",
    caption:
      "Your logo appears in the store header. Your referral link tracks every purchase that comes through your storefront.",
  },
  step3: {
    label: "Step 3 of 5",
    title: "Set brand colors & hero subtitle",
    caption:
      "Theme and accent colors style your hero banner and buttons. The hero subtitle appears below your store title on the live page.",
  },
  step4: {
    label: "Step 4 of 5",
    title: "Select product categories",
    caption:
      "Choose which categories appear in your store. Enabled categories instantly preview their products below — so you can curate exactly what your customers will see.",
  },
  step5: {
    label: "Step 5 of 5",
    title: "Save and launch",
    caption:
      "Click Save Storefront — your branded partner shop goes live instantly. No setup, no deployment, no waiting.",
  },
  preview: {
    label: "Live Store",
    title: "Your store is live",
    caption:
      "This is exactly what your customers see when they visit your partner storefront link. Fully branded, ready to sell.",
  },
}
...
const STEP_STARTS = SCRUB_STEPS.reduce(
  (acc, s, i) => {
    acc[s] = SCRUB_STEPS.slice(0, i).reduce(
      (sum, prev) => sum + DURATIONS[prev],
      0
    )
    return acc
  },
    ...
    >
      ...
      <div className="relative flex w-[330px] items-center gap-3">
        <motion.div
          ...
          style={{
            background: `linear-gradient(135deg, ${card.color}, rgba(255,255,255,0.18))`,
          }}
        >
          {card.icon}
        </motion.div>
        <div className="min-w-0">
          ...
          <h2 className="mt-0.5 truncate text-base font-black tracking-normal text-white">
            {card.title}
          </h2>
          <p className="mt-0.5 truncate text-[11px] font-medium text-white/62">
            {card.detail}
          </p>
        </div>
      </div>
...
function MotionGraphicsOverlay({
  step,
  playing,
}: {
  step: Step
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-30 overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(180deg, transparent, rgba(168,85,247,0.75), rgba(245,158,11,0.7), transparent)",
        }}
        animate={{ y: ["-100%", "100%"] }}
...
const PICKER_FILES = [
  {
    name: "livingco-logo.png",
    type: "PNG",
    size: "24 KB",
    bg: "linear-gradient(135deg,#0d9488,#059669)",
    label: "LC",
    labelColor: "#fff",
  },
  {
      ...
      >
        ...
        <button
          style={{
            ...
            borderRadius: 6,
            border: "none",
            background: selectedFile ? "#0066cc" : "#8cb4e8",
            fontSize: 12,
            color: "#fff",
            fontWeight: 600,
          }}
...
const inp =
  "w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none"
const inpActive =
  "w-full rounded-xl border-2 border-emerald-400 bg-white px-3 py-2.5 text-sm text-slate-800 outline-none ring-4 ring-emerald-100/60"
    ...
    <aside className="w-72 shrink-0 border-r border-slate-200 bg-white flex flex-col gap-3 p-4 overflow-y-auto">
      <div className="rounded-2xl border border-emerald-100 bg-gradient-to-br from-white via-emerald-50 to-cyan-50 p-4">
        ...
        <p className="mt-2 text-xs leading-5 text-slate-500">
          Build and manage branded partner shop pages with curated categories
          and products.
        </p>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-2">
        ...
        {[
          ["AF Axis", "/af-axis", 5],
          ["HelloWorld", "/hello-world", 8],
          ["Jujutsu Kaisen", "/jujutsu-kaisen", 3],
        ].map(([name, slug, cats]) => (
          <div
            key={String(slug)}
          ...
          >
            ...
            <p className="text-[10px] text-slate-400">
              {String(slug)} · {String(cats)} categories
            </p>
          </div>
        ))}
      </div>
  ...
  useEffect(() => {
    ...
    const seq: [number, () => void][] = [
      [
        300,
        () => {
          setCurPos({ x: 263, y: 152 })
          setCallout({ text: "Your store URL slug", field: "slug" })
        },
      ],
      [
        900,
      ...
      [
        3700,
        () => {
          setCurPos({ x: 729, y: 152 })
          setActiveField(null)
          setCallout({
            text: "Displayed on your storefront",
            field: "displayName",
          })
        },
      ],
      ...
      [
        8300,
        () => {
          setCurPos({ x: 263, y: 224 })
          setActiveField(null)
          setCallout({
            text: "Store tagline customers see first",
            field: "heroTitle",
          })
        },
      ],
      ...
      [
        12000,
        () => {
          setCurPos({ x: 729, y: 224 })
          setActiveField(null)
          setCallout({
            text: "Receive order notifications here",
            field: "email",
          })
        },
      ],
        ...
        <div className="mb-4 flex items-center justify-between rounded-2xl border border-emerald-100 bg-gradient-to-r from-emerald-50 to-cyan-50 px-4 py-3">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">
              Configure your storefront identity, hero messaging, brand assets,
              and partner settings for a polished launch.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <Field label="Hero Title">
              <input
                value={heroTitle}
                readOnly
                placeholder="Shop name Furniture Store"
...
function Step2Screen({ playing }: { playing: boolean }) {
  ...
  const referralLink = useTyping(
    "https://www.afhome.ph/ref/livingco",
    45,
    5400,
    playing
  )
  const shopUrl = useTyping(
    "https://www.afhome.ph/jujutsu-kaisen?ref=livingco",
    45,
    6900,
    playing
  )
  ...
  useEffect(() => {
    ...
    const seq: [number, () => void][] = [
      [
        400,
        () => {
          setCurPos({ x: 420, y: 158 })
          setCallout("Upload your brand logo")
        },
      ],
      [
        1100,
      ...
      [
        7000,
        () => {
          setCurPos({ x: 730, y: 336 })
          setCallout("Your partner shop URL")
        },
      ],
    ...
    <div className="relative flex-1">
      <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-5 m-4">
        <div className="mb-4 rounded-2xl border border-emerald-100 bg-gradient-to-r from-emerald-50 to-cyan-50 px-4 py-3">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Upload your brand assets and add your referral and shop links.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {/* Logo Upload */}
          <div className="relative">
            {callout === "Upload your brand logo" && (
              <div className="absolute -top-7 right-0 z-50">
                <Callout text="Upload your brand logo" />
              </div>
            )}
          ...
          {/* Referral & Shop Link */}
          <div className="relative">
            {callout === "Your referral tracking link" && (
              <div className="absolute -top-7 left-0 z-50">
                <Callout text="Your referral tracking link" />
              </div>
            )}
            {callout === "Your partner shop URL" && (
              <div className="absolute -top-7 left-0 z-50">
                <Callout text="Your partner shop URL" />
              </div>
            )}
      ...
      <AnimatePresence>
        {showFilePicker && (
          <FilePickerDialog x={160} y={25} selectedFile={selectedFile} />
        )}
      </AnimatePresence>
...
function Step3Screen({ playing }: { playing: boolean }) {
  ...
  const subtitle = useTyping(
    "Curated home products for every Filipino home.",
    48,
    5400,
    playing
  )
  ...
  useEffect(() => {
    ...
    const seq: [number, () => void][] = [
      [
        400,
        () => {
          setCurPos({ x: 263, y: 168 })
          setCallout("Pick your primary brand color")
        },
      ],
      [
        1100,
        () =>
          click(() => {
            setCallout("")
            setPickerFor("theme")
            setPickerHover("#0f766e")
          }),
      ],
      [
        1550,
        () => {
          setCurPos({ x: 292, y: 366 })
          setPickerHover("#1d4ed8")
        },
      ],
      [
        2300,
      ...
      [
        2900,
        () => {
          setCurPos({ x: 729, y: 168 })
          setCallout("Pick your accent / button color")
        },
      ],
      [
        3600,
        () =>
          click(() => {
            setCallout("")
            setPickerFor("accent")
            setPickerHover("#f97316")
          }),
      ],
      [
        4050,
        () => {
          setCurPos({ x: 781, y: 366 })
          setPickerHover("#7c3aed")
        },
      ],
      [
        4800,
      ...
      [
        5100,
        () => {
          setCurPos({ x: 460, y: 420 })
          setCallout("Subtitle appears below your hero title")
        },
      ],
    ...
    <div className="relative flex-1 overflow-hidden">
      <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-5 m-4">
        <div className="mb-4 rounded-2xl border border-emerald-100 bg-gradient-to-r from-emerald-50 to-cyan-50 px-4 py-3">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Set your brand colors and hero subtitle. These style your live
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="relative">
            {callout === "Pick your primary brand color" && (
              <div className="absolute -top-7 left-0 z-50">
                <Callout text="Pick your primary brand color" />
              </div>
            )}
          ...
          <div className="relative">
            {callout === "Pick your accent / button color" && (
              <div className="absolute -top-7 left-0 z-50">
                <Callout text="Pick your accent / button color" />
              </div>
            )}
        ...
        {/* Hero Subtitle */}
        <div className="relative">
          {callout === "Subtitle appears below your hero title" && (
            <div className="absolute -top-7 left-0 z-50">
              <Callout text="Subtitle appears below your hero title" />
            </div>
          )}
...
/* ─── Step 4: Categories ─────────────────────────────────────── */
const STEP4_PRODUCTS: Record<
  number,
  { name: string; price: string; emoji: string }[]
> = {
  2: [
...
const STEP4_CAT_LABELS: Record<number, string> = {
  2: "Home Decor",
  3: "Home Essentials",
  4: "Appliances",
  6: "Home & Living",
...
function Step4Screen({ playing }: { playing: boolean }) {
  ...
  useEffect(() => {
    ...
    const scrollFrames: [number, () => void][] = Array.from(
      { length: 26 },
      (_, i) =>
        [3600 + i * 28, () => setScrollY((y) => Math.min(y + 10, 260))] as [
          number,
          () => void,
        ]
    )
    ...
    const seq: [number, () => void][] = [
      [
        300,
        () => {
          setCurPos({ x: 728, y: 126 })
          setCallout("Click to enable this category")
        },
      ],
      [
        900,
      ...
      [
        1400,
        () => {
          setCurPos({ x: 728, y: 194 })
          setCallout("Add another category")
        },
      ],
      [
        2100,
      ...
      [
        ...
        () =>
          setCallout(
            "Scroll down — you can also choose which products to show"
          ),
      ],
      [3400, () => setCallout("")],
      ...
      [
        4500,
        () => {
          setCurPos({ x: 68, y: 234 })
          setCallout("Uncheck to hide this product from your store")
        },
      ],
      [
        5300,
      ...
      [
        ...
        () =>
          click(() => {
            setHiddenProducts((p) => [...p, "4-0"])
            setCallout("Hidden products won't appear in your store")
          }),
      ],
      [8300, () => setCallout("")],
    ]

    const allTimers = [...seq, ...scrollFrames].map(([t, fn]) =>
      setTimeout(fn as () => void, t as number)
    )
    return () => allTimers.forEach(clearTimeout)
  }, [playing])

  const enabledCount =
    selected.reduce((s, id) => s + (STEP4_PRODUCTS[id]?.length ?? 0), 0) -
        ...
        <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-5 m-4">
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">
                Enable categories and fine-tune which products appear in your
                partner store.
              </p>
            </div>
            ...
            {cats.map((cat) => {
              ...
              return (
                ...
                >
                  <div>
                    <p
                      className={`text-sm font-semibold ${active ? "text-emerald-900" : "text-slate-700"}`}
                    >
                      {cat.name}
                    </p>
                    <p className="text-xs text-slate-400">
                      ID {cat.id} · {cat.count} items
                    </p>
                  </div>
                  <motion.div
                    animate={{
    ...
    <div className="relative flex-1 overflow-hidden">
      <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-5 m-4">
        <div className="mb-4 rounded-2xl border border-emerald-100 bg-gradient-to-r from-emerald-50 to-cyan-50 px-4 py-3">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Review your settings and save your storefront to push it live.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-5">
          {[
            {
              label: "Store URL",
              value: "http://localhost:3000/jujutsu-kaisen",
            },
...
const FALLBACK_PREVIEW_PRODUCTS: TutorialProduct[] = [
  ...
  },
  {
    ...
    priceSrp: 5299,
    priceDp: 5299,
    image: "/Images/HeroSection/living_room.jpg",
    qty: 9,
  },
  {
    id: 9003,
    ...
    priceSrp: 1899,
    priceDp: 1899,
    image: "/Images/HeroSection/curtains.jpg",
    qty: 18,
  },
  {
    id: 9004,
...
const resolvePreviewAssetUrl = (
  ...
  if (
    ...
    return value
  return apiUrl
    ? `${apiUrl.replace(/\/$/, "")}/${value.replace(/^\/+/, "")}`
    : `/${value.replace(/^\/+/, "")}`
}

const normalizePreviewProduct = (
...
function CheckoutDemoOverlay({
  ...
  const price = Number(
    product.priceDp ?? product.priceSrp ?? product.price ?? 0
  )
              ...
              <div className="col-span-2 space-y-4">
                      ...
                      <div key={label}>
                        ...
                        <div className="h-10 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700">
                          <motion.span
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 0.28 + index * 0.18 }}
                          >
                            {value}
                          </motion.span>
                        </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <div
                        key={label}
                        className={
                          label === "Street Address" ? "col-span-2" : ""
                        }
                      >
                        <label className="mb-1.5 block text-xs font-semibold text-slate-600">
                          {label}
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {["GCash", "Card", "Online Banking"].map(
                      (method, index) => (
                        <motion.div
                          key={method}
                          animate={{
                            borderColor:
                              stage >= 4 && index === 0 ? "#0ea5e9" : "#e2e8f0",
                            backgroundColor:
                              stage >= 4 && index === 0 ? "#f0f9ff" : "#ffffff",
                          }}
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-4 space-y-2 border-t border-slate-100 pt-4 text-sm">
                  ...
                  <div className="flex justify-between text-base font-black text-slate-900">
                    <span>Total</span>
                    <span>{formatPeso(price + 180)}</span>
                  </div>
                </div>
                <motion.div
                  animate={{
            ...
            <div className="flex h-[calc(100%-73px)] items-center justify-center bg-white">
              ...
              >
                <div className="border-b border-gray-100 px-8 py-8 text-center">
                  ...
                  <h1 className="mt-4 text-2xl font-black text-green-700">
                    Payment Successful!
                  </h1>
                ...
                <div className="space-y-4 px-6 py-6">
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <div className="rounded-xl border border-slate-200 bg-white py-3 text-center text-sm font-semibold text-slate-700">
                      Track This Order
                    </div>
                    <div className="rounded-xl bg-sky-500 py-3 text-center text-sm font-semibold text-white">
                      Back to Home
                    </div>
                  </div>
                  <p className="text-center text-[11px] text-gray-400">
                    Secured by PayMongo · AF Home
                  </p>
                </div>
              </motion.div>
            </div>
...
function PreviewScreen({ playing }: { playing: boolean }) {
  ...
  const [products, setProducts] = useState<TutorialProduct[]>(
    FALLBACK_PREVIEW_PRODUCTS
  )
  const [categories, setCategories] = useState<Category[]>([])
  const [isLoadingData, setIsLoadingData] = useState(() =>
    Boolean(process.env.NEXT_PUBLIC_LARAVEL_API_URL)
  )
    ...
    const loadPreviewData = async () => {
      try {
        const [productsResponse, categoriesResponse] = await Promise.all([
          fetch(`${baseUrl}/api/products?page=1&per_page=24&status=1`, {
            headers: { Accept: "application/json" },
          }),
          fetch(`${baseUrl}/api/categories?used_only=1&per_page=100`, {
            headers: { Accept: "application/json" },
          }),
        ])

        const productsJson = productsResponse.ok
          ? ((await productsResponse.json()) as ProductsApiResponse)
          : { products: [] }
        const categoriesJson = categoriesResponse.ok
          ? ((await categoriesResponse.json()) as CategoriesApiResponse)
          : { categories: [] }
        const nextProducts = (productsJson.products ?? []).map((product) =>
          normalizePreviewProduct(product, baseUrl)
        )

        if (!cancelled) {
          setProducts(
            nextProducts.length > 0 ? nextProducts : FALLBACK_PREVIEW_PRODUCTS
          )
    ...
    const seq: [number, () => void][] = [
      [
        ...
        () => {
          ...
          setListingScrolled(false)
          setHighlightAddCart(false)
        },
      ],
      [
        800,
        () =>
          setCallout(
            "Your live partner storefront, loaded from the real system"
          ),
      ],
      [2500, () => setCallout("")],
      [
        ...
        () =>
          setCallout(
            "Scroll through the storefront to browse featured products"
          ),
      ],
      ...
      [
        ...
        () =>
          click(() => {
            setShowListing(true)
            setCallout(
              "Products, images, filters, and cards come from backend data"
            )
          }),
      ],
      ...
      [
        7000,
        () => {
          setListingScrolled(true)
          setCallout("The customer scrolls the product list to view more items")
        },
      ],
      ...
      [
        8500,
        () =>
          setCallout("The product card hover reveals the Add to Cart button"),
      ],
      ...
      [
        ...
        () =>
          setCallout(
            "The cart opens, then continues to the secure checkout page"
          ),
      ],
      ...
      [
        ...
        () =>
          setCallout(
            "Checkout captures customer contact information and referral source"
          ),
      ],
      ...
      [
        ...
        () =>
          setCallout(
            "Delivery address and payment method are selected before placing the order"
          ),
      ],
      ...
      [
        ...
        () =>
          setCallout(
            "Place Order creates the checkout session and processes payment securely"
          ),
      ],
      ...
      [
        22700,
        () =>
          setCallout("Success page confirms payment and shows the next steps"),
      ],
      [28200, () => setCallout("")],
    ]

    const allTimers = seq.map(([t, fn]) =>
      setTimeout(fn as () => void, t as number)
    )
    return () => allTimers.forEach(clearTimeout)
  }, [playing])
            ...
            >
              <div className="mx-auto max-w-7xl px-6 py-5">
                <div className="flex items-center justify-between gap-5 rounded-[28px] bg-white/92 p-6 shadow-sm backdrop-blur">
                  ...
                  <div className="flex items-center gap-3">
                    <button className="rounded-full bg-teal-700 px-5 py-2.5 text-sm font-semibold text-white shadow-sm">
                      Login
                    </button>
                    <button className="rounded-full border border-slate-300 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700">
                      LivingCo Products
                    </button>
                  </div>
                </div>
              ...
              <div className="mx-auto flex max-w-7xl items-center justify-between text-xs text-slate-500">
                ...
                <p>
                  {isLoadingData
                    ...
                    : `${products.length} backend products available`}
                </p>
              </div>
            </footer>
            <motion.div
              ...
              animate={{
                opacity: storeScrolled ? 1 : 0,
                y: storeScrolled ? 0 : 14,
              }}
                    ...
                    <motion.div
                      ...
                      className={
                        highlightAddCart && index === 0
                          ? "relative z-[60] rounded-lg ring-2 ring-sky-400 ring-offset-2 ring-offset-[#faf8f5]"
                          : ""
                      }
                    >
                      <ItemCard
...
export default function StorefrontTutorial() {
  ...
  const playSound = useCallback(
    (kind: "play" | "pause" | "step" | "success" | "replay") => {
  ...
  useEffect(() => {
    const update = () => {
      ...
      const effectiveWidth = mobileTheater
        ? Math.max(rawWidth, rawHeight)
        : rawWidth
      const effectiveHeight = mobileTheater
  ...
  const handleDownloadVideo = async () => {
    ...
    try {
      const response = await fetch(TUTORIAL_VIDEO_DOWNLOAD_URL, {
        method: "HEAD",
      })
      if (!response.ok) {
        window.alert(
          "Downloadable tutorial video is not available yet. Add storefront-tutorial.mp4 in public/videos first."
        )
        return
      }
  ...
  const jumpToStep = (targetStep: Step) => {
    ...
    const start =
      targetStep === "ending" ? TOTAL_DURATION : getStepStart(targetStep)
    justSeeked.current = true
    elapsedRef.current = start
    setElapsed(start)
    setStep(targetStep)
  ...
  const isTimelineComplete =
    step === "ending" || elapsed >= TOTAL_DURATION - 100
  const showControls =
    !fullscreenActive || controlsVisible || !playing || isTimelineComplete
  const currentUrlBar =
    step === "preview" ? urlBar : "admin.afhome.ph/partner-storefronts"
  const rootStyle = {
      ...
      <div style={playerShellStyle}>
          ...
          >
            ...
            <div
              style={{
                ...
                boxShadow:
                  "0 50px 140px rgba(0,0,0,0.9), inset 0 1px 0 rgba(255,255,255,0.55), 0 0 0 1px rgba(0,0,0,0.4)",
                flexShrink: 0,
              }}
            >
              {/* Camera dot */}
              ...
              >
                ...
                >
                  {/* Tab bar */}
                  <div
                    className="flex items-end px-4 pt-2"
                    style={{ height: 36 }}
                  >
                    <div
                  ...
                  >
                    ...
                    <div
                      className="flex gap-0 text-[#aaa] select-none"
                ...
                <AnimatePresence>
                  {(showInitialPlayButton ||
                    ...
                    <motion.button
                      ...
                      aria-label={
                        showInitialPlayButton
                          ? "Play storefront tutorial"
                          : "Resume storefront tutorial"
                      }
                    >
        ...
        <div
          style={{
            width: Math.min(
              BEZEL_W * scale,
              viewportWidth - (fullscreenActive ? 0 : 16)
            ),
            flexShrink: 0,
            ...
            transform: fullscreenActive
              ? `translate(-50%, ${showControls ? "0" : "22px"})`
              : "none",
            opacity: showControls ? 1 : 0,
            pointerEvents: showControls ? ("auto" as const) : ("none" as const),
            transition:
              "width 420ms cubic-bezier(0.22, 1, 0.36, 1), opacity 220ms ease, transform 260ms cubic-bezier(0.22, 1, 0.36, 1)",
          }}
        >
          <div
            style={{
