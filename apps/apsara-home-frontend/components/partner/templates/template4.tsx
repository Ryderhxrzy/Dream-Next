...
export default function Template4({
  ...
  const highlights = aboutHighlights?.length
    ? aboutHighlights
    : defaultHighlights
      ...
      icon: (
        ...
        >
          <path
            ...
            d="M3 3h18M3 9h18M9 3v18M3 21h6"
          />
          <rect
            x="13"
            y="13"
      ...
      icon: (
        ...
        >
          ...
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M23 20v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"
          />
        </svg>
      ),
  ...
  return (
    <>
      ...
      <S id="nav" label="Nav" selected={sel("nav")} onClick={onSectionClick}>
        <nav
          className="sticky top-0 z-50 border-b border-slate-100 bg-white px-5 py-4 md:px-16"
            ...
            <div className="flex min-w-0 items-center gap-2">
              {navLogo ? (
                <img
                  src={navLogo}
                  alt={storeName}
                  className="h-10 w-auto shrink-0 rounded-xl object-contain"
                />
              ) : (
                <div
          ...
          <section className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-5 py-12 @md:grid-cols-2 @md:px-16 @md:py-20">
            <div className={heroTextAlign}>
              ...
              <div className={`mt-6 flex flex-wrap gap-3 ${heroBtnAlign}`}>
                ...
                <button
                  type="button"
                  className="flex items-center gap-2 rounded-lg border border-slate-200 px-6 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
                >
                  {heroBtnSecondary}
                  <svg
              ...
              <div
                className={`mt-6 flex flex-wrap items-center gap-4 ${heroBtnAlign}`}
              >
                {[
                  {
                    label: trustBadge1,
            ...
            <div className="relative hidden @md:block">
              <div
                className="relative rounded-2xl border border-slate-200 bg-white p-4 shadow-xl"
                ...
                <div className="mb-3 grid grid-cols-2 gap-2 @lg:grid-cols-4">
                  {[
                    ...
                    >
                      ...
                      <p className="mt-0.5 text-[9px] font-semibold text-emerald-500">
                        {s.delta}
                      </p>
                    </div>
                  ))}
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="col-span-2 rounded-lg bg-slate-50 p-2.5">
                    ...
                    >
                      ...
                      <path
                        d="M0,58 C20,50 35,30 50,38 C65,46 80,15 100,20 C120,25 135,38 155,28 C170,20 185,32 200,24 L200,70 L0,70 Z"
                        fill="url(#t4g)"
                      />
                      <path
                        d="M0,58 C20,50 35,30 50,38 C65,46 80,15 100,20 C120,25 135,38 155,28 C170,20 185,32 200,24"
                        fill="none"
                        stroke={primaryColor}
                        strokeWidth="2"
                        strokeLinecap="round"
        ...
        >
          <section className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-5 py-12 @md:grid-cols-2 @md:px-16 @md:py-24">
            ...
            <div>
              ...
              <button
                type="button"
                className="mt-8 rounded-lg bg-[#111827] px-6 py-3 text-sm font-bold text-white transition hover:bg-[#1f2937]"
              >
                Learn More About Us
              </button>
            </div>
          ...
          <section className="bg-slate-50 px-5 py-12 @md:px-16 @md:py-20">
            <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 @md:grid-cols-2">
              <div>
                ...
                <button
                  type="button"
                  className="mt-7 flex items-center gap-2 rounded-lg bg-[#111827] px-6 py-3 text-sm font-bold text-white transition hover:bg-[#1f2937]"
                >
                  {ctaBtnText}
                  <svg
                    className="h-3.5 w-3.5"
                      ...
                      icon: (
                        ...
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.15 12 19.79 19.79 0 0 1 1.07 3.4 2 2 0 0 1 3.04 1.21h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.68 2.81a2 2 0 0 1-.45 2.11L7.09 9a16 16 0 0 0 7.91 7.91l1.16-1.16a2 2 0 0 1 2.11-.45c.91.32 1.85.55 2.81.68A2 2 0 0 1 22 16.92z"
                          />
                        </svg>
                      ),
                      text: ctaPhone,
        ...
        >
          <footer className="border-t border-slate-100 bg-white px-5 py-8 @md:px-16">
            <div className="mx-auto flex max-w-7xl flex-col items-center gap-6 @md:flex-row @md:justify-between">
              ...
              <div className="flex items-center gap-3">
                {[
                  {
                    href: socialFacebook,
                    src: "/Images/icon_apps/fb.png",
                    alt: "Facebook",
                  },
                  {
                    href: socialInstagram,
                    src: "/Images/icon_apps/instagram.png",
                    alt: "Instagram",
                  },
            ...
            <p className="mt-5 text-center text-[11px] text-slate-400">
              © {new Date().getFullYear()} {storeName}, Inc. All rights
              reserved.
            </p>
          </footer>
        </S>
