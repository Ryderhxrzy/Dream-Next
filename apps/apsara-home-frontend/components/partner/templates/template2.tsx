      ...
      <section className="mx-auto grid max-w-7xl items-center gap-12 px-10 py-20 md:grid-cols-2">
        <div>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-5">
            {["Free Delivery", "Easy Returns", "Quality Guarantee"].map(
              (badge) => (
                <span
                  key={badge}
            ...
            {[
              {
                ...
                desc: "500+ premium pieces at your fingertips.",
              },
              {
                icon: "🚚",
                title: "Nationwide Delivery",
                desc: "We ship directly to your customers.",
              },
              {
                icon: "💳",
                title: "Easy Payments",
                desc: "GCash, cards, and more accepted.",
              },
              {
                icon: "📈",
                title: "Real-time Analytics",
                desc: "Know your numbers at a glance.",
              },
            ].map((f) => (
              <div
                key={f.title}
