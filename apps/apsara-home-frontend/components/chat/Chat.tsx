...
export default function Chat({
  ...
  return (
    <div
      className={`fixed z-50 flex flex-col ${mode === "chat" ? "bottom-0 right-6" : "top-16 right-4"}`}
    >
      <div
        className={`flex ${mode === "chat" ? "h-[500px] w-[380px] rounded-t-2xl" : "h-[500px] w-[380px] rounded-lg"} flex-col bg-white shadow-2xl border border-gray-200`}
      >
        {/* Header */}
