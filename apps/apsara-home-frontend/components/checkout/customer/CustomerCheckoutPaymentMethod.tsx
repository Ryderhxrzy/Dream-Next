            ...
            <button
              ...
              className={`text-left rounded-2xl border-2 p-4 transition-all flex items-center gap-3 ${
                selected
                  ...
                  : "border-slate-200 dark:border-slate-700 hover:border-sky-200 dark:hover:border-sky-700 bg-white dark:bg-slate-900"
              }`}
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  <span
                    className={`px-1.5 py-0.5 rounded-md text-[9px] font-bold text-white ${method.badgeColor}`}
                  >
                    {method.badge}
                  </span>
                </div>
              ...
              <div
                className={`h-5 w-5 rounded-full border-2 flex items-center justify-center shrink-0 transition-all ${
                  selected
                    ? "border-sky-500 dark:border-sky-400 bg-sky-500 dark:bg-sky-500"
        ...
        {selectedMethod === "online_banking" && (
          ...
          >
            <div className="mt-3 p-4 rounded-2xl border border-sky-200 dark:border-sky-900 bg-sky-50 dark:bg-sky-900/20">
              {showOnlineBankingProviderPicker ? (
                <>
                  <p className="text-xs font-bold text-sky-700 dark:text-sky-400 mb-2.5">
                    Choose your bank
                  </p>
                      ...
                      <button
                        ...
                        className={`rounded-xl border-2 px-3 py-3 text-left transition-all ${
                          selectedOnlineBankingProvider === bank.id
                            ? "border-sky-600 dark:border-sky-500 bg-sky-600 dark:bg-sky-600 text-white"
                            : "border-sky-200 dark:border-sky-800 bg-white dark:bg-slate-900 text-sky-700 dark:text-sky-400 hover:border-sky-400 dark:hover:border-sky-600"
                        }`}
                      >
                ...
                {cardOptions.map((card) => (
                  <button
                    ...
                    className={`flex-1 py-2.5 rounded-xl border-2 transition-all flex items-center justify-center gap-2 ${
                      selectedCard === card
                        ? "border-slate-800 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 "
