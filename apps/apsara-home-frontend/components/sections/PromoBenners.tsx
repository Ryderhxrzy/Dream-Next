        ...
        <section className="container mx-auto px-4 py-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <motion.div
                    ...
                    className="relative rounded-3xl overflow-hidden h-96 cursor-pointer group"
                >
                    <Image src="/Images/PromoBanners/ct2-img2-large.jpg" alt="Appliances" fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover transition-transform duration-700 group-hover:scale-105" />
