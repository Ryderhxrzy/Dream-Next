        ...
        >
          ...
          {subscribed ? (
            ...
            >
              ...
              <button
                type="submit"
                className="bg-orange-500 hover:bg-orange-600 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold rounded-full px-8 py-3 text-base cursor-pointer transition-all duration-200"
              >
                Subscribe
              </button>
            </form>
