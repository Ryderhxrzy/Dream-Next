...
function DiagramLightbox({
  ...
  const screenToSvg = useCallback((sx: number, sy: number, cv: VB) => {
    ...
    return {
      x: cv.x + ((sx - r.left) / r.width) * cv.w,
      y: cv.y + ((sy - r.top) / r.height) * cv.h,
    }
  }, [])
  ...
  const zoomAt = useCallback(
    (factor: number, px?: number, py?: number) => {
      setVb((prev) => {
        ...
        return {
          x: cx - (cx - prev.x) * (nw / prev.w),
          y: cy - (cy - prev.y) * (nh / prev.h),
          w: nw,
          h: nh,
        }
      })
  ...
  const clampPan = useCallback(
    (v: VB): VB => {
      ...
      return {
        ...
        x: Math.max(
          origVB.x - v.w * s,
          Math.min(origVB.x + origVB.w - v.w * (1 - s), v.x)
        ),
        y: Math.max(
          origVB.y - v.h * s,
          Math.min(origVB.y + origVB.h - v.h * (1 - s), v.y)
        ),
      }
    },
    [origVB]
...
function Note({
  ...
  const map = {
    info: "border-amber-400 bg-amber-50 text-amber-900",
      ...
      <div className="border-b border-amber-100 px-3 py-3">
        <div className="flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2">
          ...
          <input
            ...
            className="flex-1 bg-transparent text-xs text-gray-700 placeholder-amber-300 outline-none"
          />
          {search && (
            <button onClick={() => setSearch("")}>
              <X size={12} className="text-amber-400 hover:text-amber-600" />
            </button>
          )}
        </div>
      </div>
        ...
        {mobileOpen && (
          <>
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="commission-docs-lightbox fixed inset-0 z-40 bg-black/40 lg:hidden"
        ...
        <div className="commission-docs-content mx-auto max-w-3xl space-y-0 px-6 py-10 pb-24">
          ...
          <section id="pv" data-section>
            ...
            <p className="mb-5 text-[15px] leading-relaxed text-gray-600">
              ...
              <strong>after an order has been delivered</strong> — never on
              payment alone.
            </p>
            <Note type="info">
              PV is only earned on delivery. This prevents PV from being granted
              for orders that are cancelled, returned, or never received.
            </Note>
          </section>
          ...
          <section id="pv-distribution" data-section className="pt-2">
            ...
            <InfoTable
              ...
              rows={[
                [
                  <span key="a" className="font-semibold text-amber-700">
                    Personal Cashback
                  </span>,
                  <Badge key="b" label="4%" />,
                  "Personal checkout discount balance earned by the buyer",
                ],
                [
                  <span key="c" className="font-semibold text-amber-700">
                    Group Purchase Bonus
                  </span>,
                  <Badge key="d" label="6%" />,
                  "Distributed to up to 10 levels of uplines",
                ],
                [
                  <span key="e" className="font-semibold text-amber-700">
                    Affiliate Performance
                  </span>,
                  <Badge key="f" label="2.9%" />,
                  "Funds milestone bonuses for the buyer's direct sponsor",
                ],
                [
                  <span key="g" className="font-semibold text-amber-700">
                    Yearly Global Bonus
                  </span>,
                  <Badge key="h" label="1%" />,
                  "Year-end reward for top PV earners",
                ],
                [
                  <span key="i" className="font-semibold text-amber-700">
                    Product Purchase Points
                  </span>,
                  <Badge key="j" label="86.1%" color="gray" />,
                  "Points credited to the buyer",
                ],
              ]}
            />
            <Note type="tip">
              The full 100% of PV is always accounted for — nothing is lost or
              unallocated.
            </Note>
          </section>
          ...
          <section id="activation" data-section>
            ...
            <p className="mb-5 text-[15px] leading-relaxed text-gray-600">
              ...
              member&apos;s own cashback or direct referral commission.
            </p>
          </section>
          ...
          <section id="activation-windows" data-section className="pt-2">
            ...
            <InfoTable
              ...
              rows={[
                [
                  <span key="e" className="font-semibold text-emerald-700">
                    Early Window
                  </span>,
                ...
                [
                  <span key="l" className="font-semibold text-orange-700">
                    Late Window
                  </span>,
                  "Days 8 onwards",
                  "200 PV (total for the month)",
                ],
              ]}
            />
            <Note type="info">
              Purchasing early requires <strong>less PV (100 PV)</strong> to
              stay active. Purchasing late requires{" "}
              <strong>more effort (200 PV total)</strong> to qualify.
            </Note>
          </section>

          <section id="activation-effects" data-section className="pt-2">
            <SubHeading id="activation-effects">
              What Activation Affects
            </SubHeading>
            <InfoTable
              headers={["Bonus", "Activated Member", "Inactive Member"]}
              rows={[
                [
                  "Unilevel (Group Purchase Bonus)",
                  <Badge key="a" label="Receives their share" color="green" />,
                  <Badge
                    key="b"
                    label="Skipped — bonus passes up"
                    color="gray"
                  />,
                ],
                [
                  "Affiliate Performance Bonus",
                  <Badge key="c" label="Eligible on milestone" color="green" />,
                  <Badge key="d" label="Does not receive" color="gray" />,
                ],
                [
                  "Personal Cashback Discount",
                  <Badge key="e" label="Always received" color="green" />,
                  <Badge key="f" label="Always received" color="green" />,
                ],
                [
                  "Direct Referral Commission",
                  <Badge key="g" label="Always received" color="green" />,
                  <Badge key="h" label="Always received" color="green" />,
                ],
              ]}
            />
            <Note type="warning">
              If a member is inactive, they are &quot;invisible&quot; in the
              unilevel chain that month. Their downline&apos;s PV still flows
              upward, but the bonus goes to the next active person above them.
            </Note>
          </section>
          ...
          <section id="ranks" data-section>
            ...
            <p className="mb-5 text-[15px] leading-relaxed text-gray-600">
              ...
              <strong>All criteria must be met at the same time</strong> to hold
              a rank.
            </p>
          </section>
            ...
            <InfoTable
              ...
              rows={[
                [
                  ...
                  "—",
                  "—",
                  "Default rank (no requirements)",
                ],
                [
                  "2",
                  <span key="hb" className="font-semibold">
                    Home Builder
                  </span>,
                  "300",
                  "2",
                ...
                [
                  "3",
                  <span key="hs" className="font-semibold text-amber-700">
                    Home Stylist
                  </span>,
                  "1,000",
                  "5",
                  "—",
                  "2 active directs (≥300 PV each)",
                ],
                [
                  "4",
                  <span key="lc" className="font-semibold text-amber-700">
                    Lifestyle Consultant
                  </span>,
                  "3,000",
                  "10",
                  "10,000",
                  "5 direct Home Builders or higher",
                ],
                [
                  "5",
                  <span key="le" className="font-bold text-amber-800">
                    Lifestyle Elite
                  </span>,
                  "8,000",
                  "20",
                  "30,000",
                  "10 direct Home Stylists or higher",
                ],
              ]}
            />
            <InfoTable
              ...
              rows={[
                [
                  "Personal PV",
                  "PV from the member's own purchases only — not from their downline",
                ],
                ["Directs", "Members the person personally sponsored/referred"],
                [
                  "Group PV",
                  "Total PV of the member's entire network (all levels, all downlines combined)",
                ],
                [
                  "Active Directs",
                  "Direct members who have at least 300 PV themselves",
                ],
              ]}
            />
          </section>
          ...
          <section id="ranks-unilevel" data-section className="pt-2">
            ...
            <p className="mb-4 text-sm text-gray-600">
              ...
              downline with a delivered order, they receive unilevel bonuses
              regardless of rank.
            </p>
            <Note type="tip">
              Rank is used for tier promotion requirements (Personal PV, directs
              count, Group PV) — not as a gate for unilevel earnings.
            </Note>
          </section>
...
Order Delivered → Both portions released (Available)`}</FormulaBlock>
          ...
          <section id="referral-rules" data-section className="pt-2">
            ...
            <InfoTable
              ...
              rows={[
                [
                  "First purchase only",
                  "Only the referred member's very first order triggers this bonus — repeat orders do not",
                ],
                [
                  "Self-referral not allowed",
                  "A member cannot earn commission from their own purchases",
                ],
                [
                  "No activation required",
                  "This bonus is always earned as long as the first order completes — activation status does not matter",
                ],
                [
                  "Cancelled orders",
                  "Pending commission is cancelled if the order is cancelled",
                ],
              ]}
            />
          </section>
          ...
          <section id="unilevel" data-section>
            <SectionTag icon={<BarChart3 size={11} />}>
              Group Purchase Bonus
            </SectionTag>
            ...
            <p className="mb-5 text-[15px] leading-relaxed text-gray-600">
              ...
              <strong>upward</strong> through the sponsor chain.
            </p>
          </section>
          ...
          <section id="unilevel-rate" data-section className="pt-2">
            ...
            />
            <Note type="tip">
              Levels are counted <strong>from the buyer upward</strong> — Level
              1 is the buyer&apos;s direct sponsor, Level 2 is the
            ...
            <InfoTable
              ...
              rows={[
                ...
                [
                  "Levels 4–10",
                  "Each upline continuing up the chain",
                  "₱6.00 each",
                ],
                [
                  <strong key="t">Total</strong>,
                  "",
                  <strong key="v">₱60.00 (6% of ₱1,000)</strong>,
                ],
              ]}
            />
            <Note type="info">
              All monthly-active members receive unilevel bonuses regardless of
              rank — as long as they have at least one direct downline with a
              delivered order.
            </Note>
          </section>
          ...
          <section id="unilevel-compression" data-section className="pt-2">
            ...
            <Note type="warning">
              Inactive members are skipped — not permanently removed. They
              return to their position next month if they reactivate.
            </Note>
          </section>
          ...
          <section id="affiliate" data-section>
            ...
            <p className="mb-5 text-[15px] leading-relaxed text-gray-600">
              ...
              month the milestone is crossed.
            </p>
          </section>
...
Resets to 0 every 1st of the month — earnable again each month.`}</FormulaBlock>
            <Note type="warning">
              The PV counter resets every 1st of the month. Only the current
              month&apos;s direct PV counts toward milestones — previous months
              do not carry over.
            </Note>
          </section>

          <Note type="info">
            The threshold is fixed at 50,000 PV. When the sponsor reaches it,
            PHP 5,000 is credited and the visible progress meter resets to 0 for
            the next 50,000 PV cycle within the same month.
          </Note>

          <section id="affiliate-milestones" data-section className="pt-2">
            <SubHeading id="affiliate-milestones">
              Milestone Table (per month)
            </SubHeading>
            <InfoTable
              headers={[
                "Monthly Direct PV",
            ...
            />
            <Note type="info">
              Next month starts fresh at 0 — a sponsor who hit ₱20,000 in
              bonuses last month can earn ₱20,000 again if their directs reach
              the same PV.
            </Note>
          </section>
          ...
          <section id="cashback" data-section>
            ...
            <p className="mb-5 text-[15px] leading-relaxed text-gray-600">
              ...
              can auto-apply as a checkout discount on eligible products.
            </p>
            <InfoTable
              ...
              rows={[
                ...
                [
                  "When credited",
                  "After the member order is delivered / completed",
                ],
                [
                  "How it is used",
                  "Auto-applied at checkout as Personal Cashback Discount when product rules allow it",
                ],
                [
                  "Product limits",
                  "Supplier/admin voucher product rules control allow, max discount, and minimum spend",
                ],
            ...
            <InfoTable
              ...
              rows={[
                [
                  "500 PV",
                  "PHP 20 cashback balance",
                  "Auto-applies up to product max discount",
                ],
                [
                  "1,000 PV",
                  "PHP 40 cashback balance",
                  "Auto-applies up to product max discount",
                ],
                [
                  "3,000 PV",
                  "PHP 120 cashback balance",
                  "Auto-applies up to product max discount",
                ],
              ]}
            />
            <Note type="info">
              E-GC and Personal Cashback are separate balances. E-GC is
              electronic gift credit from commission programs; Personal Cashback
              is the buyer&apos;s own 4% cashback discount balance.
            </Note>
          </section>
          ...
          <section id="global" data-section>
            ...
            <InfoTable
              ...
              rows={[
                [
                  "1",
                  "All members are ranked by total PV earned within that calendar year",
                ],
                [
                  "2",
                  "The top 10 members each receive 1% of their yearly PV total as a cash bonus",
                ],
                [
                  "3",
                  "In case of a tie, the member who joined earlier takes the higher spot",
                ],
                [
                  "4",
                  "This bonus is awarded once per year by the administration",
                ],
              ]}
            />
            <InfoTable
              ...
              rows={[
                [
                  <Badge key="1" label="1st" color="amber" />,
                  "500,000 PV",
                  "₱5,000",
                ],
                [
                  <Badge key="2" label="2nd" color="amber" />,
                  "400,000 PV",
                  "₱4,000",
                ],
                [
                  <Badge key="3" label="3rd" color="amber" />,
                  "350,000 PV",
                  "₱3,500",
                ],
                ["...", "...", "..."],
            ...
            />
            <Note type="warning">
              Members not in the top 10 do not receive this bonus for that year.
            </Note>
          </section>
          ...
          <section id="rules" data-section>
            ...
            <InfoTable
              ...
              rows={[
                [
                  <span key="r1" className="font-medium">
                    PV credited on delivery only
                  </span>,
                  "No PV is earned for undelivered, cancelled, or pending orders",
                ],
                [
                  <span key="r2" className="font-medium">
                    Monthly activation for unilevel
                  </span>,
                  "Must meet the monthly PV threshold to receive group purchase bonuses",
                ],
                [
                  <span key="r3" className="font-medium">
                    Inactive uplines are skipped — not removed
                  </span>,
                  "Their position is filled by the next active upline above them",
                ],
                [
                  <span key="r4" className="font-medium">
                    Cashback is always earned
                  </span>,
                  "Personal cashback balance is credited for every delivered member order, no activation needed",
                ],
                [
                  <span key="r5" className="font-medium">
                    Rank does not restrict unilevel
                  </span>,
                  "Any active member earns from all 10 levels — rank is for tier promotion only",
                ],
                [
                  <span key="r6" className="font-medium">
                    All rank criteria must be met together
                  </span>,
                  "Meeting only some requirements does not qualify a member for that rank",
                ],
                [
                  <span key="r7" className="font-medium">
                    Group PV includes the full downline
                  </span>,
                  "Not just directs — the entire network tree counts toward Group PV",
                ],
                [
                  <span key="r8" className="font-medium">
                    Performance bonus milestones repeat
                  </span>,
                  "Every 50,000 direct PV = another ₱5,000 — no cap",
                ],
                [
                  <span key="r9" className="font-medium">
                    Self-referral not allowed
                  </span>,
                  "A member cannot earn referral commission from their own purchases",
                ],
                [
                  <span key="r10" className="font-medium">
                    No double-posting of bonuses
                  </span>,
                  "The system ensures each bonus is only awarded once per qualifying event",
                ],
              ]}
            />
          </section>
