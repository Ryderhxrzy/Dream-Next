          ...
          <div className="mt-3 grid grid-cols-5 gap-1.5">
            {PHASES.map((p) => (
              ...
              >
                ...
                <span className="max-w-full truncate text-center text-[9px] font-medium leading-none opacity-75">
                  {p.title}
                </span>
              </button>
            ))}
          ...
          {PHASES.map((phase) => (
            ...
            >
              ...
              <div className="mb-3 flex items-center gap-3">
                ...
                <div>
                  <p
                    className={`text-[10px] font-extrabold uppercase tracking-[0.18em] ${phase.accentText}`}
                  >
                    {phase.phase}
                  </p>
