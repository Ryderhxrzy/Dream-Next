...
export const notify = {
  show: (message: React.ReactNode, opts?: NotifyOptions) =>
    push("info", message, opts),
  loading: (message: React.ReactNode = "Loading…", opts?: NotifyOptions) =>
    push("loading", message, opts),
  success: (message: React.ReactNode = "Done", opts?: NotifyOptions) =>
    push("success", message, opts),
  error: (
    message: React.ReactNode = "Something went wrong",
    opts?: NotifyOptions
  ) => push("error", message, opts),
  info: (message: React.ReactNode = "Heads up", opts?: NotifyOptions) =>
    push("info", message, opts),
  warning: (message: React.ReactNode = "Careful", opts?: NotifyOptions) =>
