      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="rounded-2xl border border-gray-200 bg-slate-50 p-4 shadow-inner shadow-slate-200/40 dark:border-white/10 dark:bg-white/[0.07] dark:shadow-white/[0.02]">
          ...
          <ul className="mt-2 space-y-1 text-sm text-gray-500 dark:text-white/70">
            <li
              className={
                checks.length ? "text-emerald-600 dark:text-emerald-300" : ""
              }
            >
              {strictPassword
            ...
            {"number" in checks && (
              <li
                className={
                  checks.number ? "text-emerald-600 dark:text-emerald-300" : ""
                }
              >
                At least one number
              </li>
            ...
            {"special" in checks && (
              <li
                className={
                  checks.special ? "text-emerald-600 dark:text-emerald-300" : ""
                }
              >
