...
export default function LoginPageClient({
  ...
  useEffect(() => {
    ...
    const shouldSkipRedirect =
      window.sessionStorage.getItem(LOGIN_REDIRECT_GUARD_KEY) === "1"
  ...
  const handleTabChange = (nextMode: "login" | "signup") =>
  ...
  return (
    <div className="relative min-h-[100dvh] w-full overflow-x-hidden overflow-y-auto flex flex-col">
      ...
      >
        ...
        >
          <div
            className={`rounded-3xl border border-gray-200 bg-white shadow-2xl dark:border-white/10 dark:bg-slate-800 ${mode === "signup" ? "p-5 sm:p-9 md:p-10" : "p-5 sm:p-8"}`}
          >
            ...
            <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 py-6 text-sm text-slate-600 sm:flex-row">
              <div className="flex items-center gap-3">
                ...
                <p className="font-medium text-slate-700">
                  {partnerFooterName || "Partner Storefront"}
                </p>
              </div>
              <a
                href={partnerFooterHomeHref}
