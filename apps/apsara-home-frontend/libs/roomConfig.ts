...
const KEYWORD_RULES: Array<{ roomType: number; keywords: string[] }> = [
  ...
  {
    roomType: 7,
    keywords: ["laundry", "laundry-room", "washer", "dryer", "hamper"],
  },
  {
    roomType: 8,
    keywords: ["bathroom", "bath", "toilet", "shower", "sink", "vanity"],
  },
]
...
export const inferRoomTypeFromCategory = (
  category?: { name?: string | null; url?: string | null } | null
) => {
