...
export const partnerAuthOptions: NextAuthOptions = {
  ...
  cookies: {
    sessionToken: {
      name: isProd ? '__Secure-partner-next-auth.session-token' : 'partner-next-auth.session-token',
      options: {
        httpOnly: true,
        sameSite: 'lax',
        path: '/',
    ...
    csrfToken: {
      name: isProd ? '__Host-partner-next-auth.csrf-token' : 'partner-next-auth.csrf-token',
      options: {
        httpOnly: true,
        sameSite: 'lax',
        path: '/',
    ...
    callbackUrl: {
      name: isProd ? '__Secure-partner-next-auth.callback-url' : 'partner-next-auth.callback-url',
      options: {
        sameSite: 'lax',
        path: '/',
        secure: isProd,
