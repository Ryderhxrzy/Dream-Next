...
export const partnerAuthOptions: NextAuthOptions = {
        ...
        try {
          ...
          return {
            ...
            storefrontIds: Array.isArray(data.user.storefront_ids)
              ...
              : [],
            disabledStorefrontIds: Array.isArray(
              data.user.disabled_storefront_ids
            )
              ? data.user.disabled_storefront_ids
              : [],
  ...
  cookies: {
    ...
    csrfToken: {
      name: isProd
        ? "__Host-partner-next-auth.csrf-token"
        : "partner-next-auth.csrf-token",
      options: {
        httpOnly: true,
        sameSite: "lax",
        path: "/",
    ...
    callbackUrl: {
      name: isProd
        ? "__Secure-partner-next-auth.callback-url"
        : "partner-next-auth.callback-url",
      options: {
        sameSite: "lax",
        path: "/",
        secure: isProd,
