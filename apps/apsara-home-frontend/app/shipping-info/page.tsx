...
const DELIVERY_ZONES = [
  { area: 'Metro Manila', days: '3 – 5 business days', color: 'bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-300' },
  { area: 'Luzon (outside Metro Manila)', days: '5 – 7 business days', color: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300' },
  { area: 'Visayas & Mindanao', days: '7 – 14 business days', color: 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300' },
  { area: 'Remote Areas', days: 'Varies — team will confirm', color: 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300' },
]
...
const SECTIONS = [
  {
    ...
    content: (
      <>
        <p className="text-sm text-slate-600 dark:text-slate-300">AF Home delivers nationwide across the Philippines. Delivery timeframes vary by location:</p>
        <div className="mt-4 grid gap-2 sm:grid-cols-2">
          {DELIVERY_ZONES.map((zone) => (
            <div key={zone.area} className="flex items-center justify-between gap-3 rounded-xl border border-slate-100 bg-slate-50/60 px-4 py-3 dark:border-slate-800 dark:bg-slate-800/40">
              <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">{zone.area}</p>
              <span className={`shrink-0 rounded-full px-2.5 py-1 text-[11px] font-bold ${zone.color}`}>{zone.days}</span>
            </div>
          ))}
        </div>
        <p className="mt-3 text-xs text-slate-500 dark:text-slate-400">Business days are Monday through Saturday, excluding public holidays.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
          Shipping fees are calculated at checkout based on the delivery address and the total weight or dimensions of your order. We partner with trusted couriers to ensure your items arrive safely and on time.
        </p>
        <div className="mt-3 flex items-start gap-2.5 rounded-xl border border-sky-100 bg-sky-50/60 px-4 py-3 dark:border-sky-900/30 dark:bg-sky-950/20">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="mt-0.5 shrink-0 text-sky-500">
            <path d="M12 2l3 7 7 3-7 3-3 7-3-7-7-3 7-3 3-7z"/>
          </svg>
          <p className="text-xs text-sky-700 dark:text-sky-300">Free shipping promotions may be available during special sale events. Watch our announcements for updates.</p>
        </div>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
          Orders are processed within <span className="font-semibold text-slate-800 dark:text-slate-100">1 to 2 business days</span> after payment confirmation. You will receive a confirmation email with your order details once processing begins.
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
          Once your order has been shipped, you will receive a tracking number via email or SMS. Use this number to monitor your delivery status.
        </p>
        <div className="mt-3">
          <a
            href="/track-order"
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
          For bulky furniture and appliances, delivery is handled by our in-house logistics team or specialized freight partners. Our team will coordinate a delivery schedule with you after your order is confirmed.
        </p>
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
          If your order arrives damaged or does not arrive within the expected timeframe, contact us immediately. We will coordinate with the courier and resolve the issue as quickly as possible.
        </p>
      ...
      <div className="not-prose mb-8 overflow-hidden rounded-2xl bg-linear-to-br from-sky-500 to-cyan-600 p-7 text-white shadow-lg shadow-sky-900/20">
        <div className="flex flex-wrap items-center gap-5">
          ...
          <div className="flex-1">
            <p className="text-xs font-bold uppercase tracking-widest opacity-70">AF Home · Logistics</p>
            <h2 className="mt-1 text-xl font-bold">Fast, reliable delivery nationwide.</h2>
            <p className="mt-1 text-sm opacity-80">
              We deliver across the Philippines with trusted courier partners. Here's how it works.
            </p>
          </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-sky-200 bg-linear-to-br from-sky-50 to-cyan-50 shadow-sm dark:border-sky-900/40 dark:from-sky-950/30 dark:to-cyan-950/30">
          <div className="flex flex-wrap items-center justify-between gap-4 px-5 py-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-bold text-slate-900 dark:text-slate-100">Need shipping help?</p>
                <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">Our team will assist with any delivery concern.</p>
              </div>
            </div>
          ...
          <div className="border-t border-sky-200/60 px-5 py-3 dark:border-sky-900/30">
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Shipping rates and timeframes are subject to change. Check this page regularly for the latest information.
            </p>
          </div>
        </div>
      </div>
