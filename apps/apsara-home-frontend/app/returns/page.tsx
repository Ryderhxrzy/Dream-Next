...
export const metadata = buildPageMetadata({
  title: "Return & Refund",
  description:
    "Learn about the AF Home return and refund policy — eligibility, process, and timelines.",
  path: "/returns",
})
...
const SECTIONS = [
  {
    ...
    content: (
      <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
        At AF Home, we are committed to providing high-quality products and
        exceptional service. We understand that sometimes a purchase may not
        meet your expectations. This Return and Refund Policy outlines the terms
        and conditions under which returns and refunds are accepted.
      </p>
    ),
  },
  {
      ...
      <>
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-3">
          {[
            ...
            {
              label: "Condition",
              value: "Unused, original packaging, tags intact",
              icon: "📦",
            },
            {
              label: "Proof",
              value: "Receipt or proof of purchase required",
              icon: "🧾",
            },
          ].map((item) => (
            <div
        ...
        {[
          {
            step: "1",
            title: "Inspection",
            desc: "Upon receiving your returned item, we inspect it to ensure it meets our return criteria.",
          },
          {
            step: "2",
            title: "Refund Approval",
            desc: "If approved, your refund is processed within 7 to 10 business days to the original payment method.",
          },
          {
            step: "3",
            title: "Notification",
            desc: "You will receive an email confirming the status of your refund.",
          },
        ].map((s) => (
          <div key={s.step} className="flex items-start gap-4">
  ...
  },
  {
    ...
    content: (
      <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
        ...
        contact our customer service team. Exchanges are subject to
        availability, and you may need to return the original item before the
        new one is shipped.
      </p>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
          If you receive a damaged or defective item, contact us within{" "}
          <span className="font-semibold text-slate-800 dark:text-slate-100">
            7 days
          </span>{" "}
          of receipt. We will provide instructions for returning the item and
        ...
        <div className="flex flex-wrap items-center gap-5">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm opacity-80">
              Our return and refund policy is straightforward — 7-day returns,
              fast refunds, and a dedicated support team.
            </p>
          </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-sky-200 bg-linear-to-br from-sky-50 to-cyan-50 shadow-sm dark:border-sky-900/40 dark:from-sky-950/30 dark:to-cyan-950/30">
          ...
          <div className="border-t border-sky-200/60 px-5 py-3 dark:border-sky-900/30">
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Thank you for choosing AF Home. We appreciate your business and
