  ...
  return (
    ...
    >
      ...
      <div className="not-prose mb-8 overflow-hidden rounded-2xl bg-linear-to-br from-sky-400 to-cyan-500 p-7 text-white shadow-lg shadow-sky-900/20">
        <div className="flex flex-wrap items-center gap-5">
          ...
          <div className="flex-1">
            <p className="text-xs font-bold uppercase tracking-widest opacity-70">AF Home · Disclosure</p>
            <h2 className="mt-1 text-xl font-bold">Honest expectations, always.</h2>
            <p className="mt-1 text-sm opacity-80">
              Income results vary by individual. Please read this disclosure in full before making any financial commitment.
            </p>
          </div>
      ...
      <div className="not-prose mb-8 flex items-start gap-4 rounded-2xl border border-rose-200 bg-rose-50 px-5 py-4 dark:border-rose-900/40 dark:bg-rose-950/20">
        ...
        <div>
          <p className="text-sm font-bold text-rose-800 dark:text-rose-200">Important Notice</p>
          <p className="mt-0.5 text-sm text-rose-700 dark:text-rose-300">
            The income figures and examples referenced are not intended to represent or guarantee that anyone will achieve the same or similar results. Individual results will vary significantly.
          </p>
        </div>
      </div>
      ...
      <div className="not-prose mb-8 flex flex-wrap gap-2">
        {SECTIONS.map((s) => (
          <span key={s.number} className="rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-700 dark:border-amber-900/40 dark:bg-amber-950/30 dark:text-amber-300">
            {s.number} · {s.title}
          </span>
        ))}
      </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-sky-200 bg-linear-to-br from-sky-50 to-cyan-50 shadow-sm dark:border-sky-900/40 dark:from-sky-950/30 dark:to-cyan-950/30">
          <div className="flex flex-wrap items-center justify-between gap-4 px-5 py-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-bold text-slate-900 dark:text-slate-100">Need clarification?</p>
                <p className="mt-0.5 text-xs text-slate-600 dark:text-slate-400">Our team is happy to answer your questions.</p>
              </div>
            </div>
            <a href="mailto:info@afhome.biz" className="rounded-xl bg-sky-500 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-sky-600">
              Contact Us
            </a>
          </div>
          <div className="border-t border-sky-200/60 px-5 py-3 dark:border-sky-900/30">
            <p className="text-xs text-slate-500 dark:text-slate-400">
              By participating in the AF Home opportunity, you confirm that you have read and understood this income disclaimer in its entirety.
            </p>
          </div>
        </div>
      </div>
