    ...
    >
      ...
      <div className="not-prose mb-8 overflow-hidden rounded-2xl bg-linear-to-br from-indigo-600 to-violet-600 p-7 text-white shadow-lg shadow-indigo-900/20">
        <div className="flex flex-wrap items-center gap-5">
          ...
          <div className="flex-1">
            <p className="text-xs font-bold uppercase tracking-widest opacity-70">AF Home · Legal</p>
            <h2 className="mt-1 text-xl font-bold">Terms that protect both of us.</h2>
            <p className="mt-1 text-sm opacity-80">
              By using our platform and becoming a distributor, you agree to the following terms. Please read them carefully before proceeding.
            </p>
          </div>
      ...
      <div className="not-prose mb-8 flex flex-wrap gap-2">
        {TERMS_SECTIONS.map((s) => (
          <span key={s.number} className="rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 text-xs font-semibold text-indigo-700 dark:border-indigo-900/40 dark:bg-indigo-950/30 dark:text-indigo-300">
            {s.number} · {s.title}
          </span>
        ))}
      </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-indigo-200 bg-linear-to-br from-indigo-50 to-violet-50 shadow-sm dark:border-indigo-900/40 dark:from-indigo-950/30 dark:to-violet-950/30">
          <div className="flex flex-wrap items-center justify-between gap-4 px-5 py-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-bold text-slate-900 dark:text-slate-100">Have questions about these terms?</p>
                <p className="mt-0.5 text-xs text-slate-600 dark:text-slate-400">Our team is happy to help clarify anything.</p>
              </div>
            </div>
            <a href="mailto:info@afhome.biz" className="rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-indigo-700">
              Contact Us
            </a>
          </div>
