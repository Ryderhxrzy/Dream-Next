...
export async function POST(req: NextRequest) {
  try {
    ...
    const resourceType: UploadApiOptions['resource_type'] = isImage ? 'image' : isVideo ? 'video' : 'raw'
    ...
    return NextResponse.json({ url: result.secure_url, type: attachmentType, name: file.name })
  } catch (err) {
