...
export const metadata = buildPageMetadata({
  ...
  description:
    "Preview a premium editorial redesign for the AF Home shop page.",
  path: "/redesign",
})
            ...
            <div className="grid items-center gap-12 lg:grid-cols-[1fr_1.1fr]">
              ...
              <div className="flex flex-col gap-6">
                ...
                <p className="max-w-xs text-sm leading-7 text-[#7a7065]">
                  Premium furniture crafted for the way you live — warm,
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Link
                    href="/shop"
                    className="flex items-center gap-2 text-sm font-semibold text-[#7a7065] transition hover:text-[#1a1a1a]"
                  >
                  ...
                  {[0, 1, 2, 3, 4, 5].map((i) => (
                    <span
                      ...
                      style={{
                        width: i === 0 ? 24 : 8,
                        height: 8,
                        backgroundColor: i === 0 ? "#1a1a1a" : "#d4cec6",
                      }}
                    />
                  ))}
                </div>
        ...
        <section className="border-y border-[#e4ddd3] bg-white py-20 text-center">
          <div className={C}>
            ...
            <p className="mx-auto mt-5 max-w-xl text-sm leading-8 text-[#7a7065]">
              From statement sofas to intimate accent pieces, every product is
              curated for quality, proportion, and the warmth that makes a house
              feel like a home.
            </p>
          </div>
        </section>
                ...
                >
                  ...
                  <div className="absolute right-0 bottom-0 left-0 p-5">
                    ...
                    <p className="mt-1 text-[11px] font-medium text-white/70">
                      {"product_count" in cat ? cat.product_count || 0 : 0}{" "}
                      items
                    </p>
                  </div>
                </Link>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
                ...
                <div className="relative w-full max-w-sm">
                  ...
                  <div className="absolute -right-4 bottom-12 rounded-2xl border border-[#e4ddd3] bg-white p-4 shadow-lg">
                    ...
                    <p className="mt-1 text-sm font-bold text-[#8b6f4e]">
                      {p(3) ? formatMoney(getProductPrice(p(3))) : "₱12,990"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6">
                ...
                <p className="max-w-sm text-sm leading-8 text-[#7a7065]">
                  Every piece in the AF Home collection tells a story of craft
                  and intention — furniture designed not just to fill a room,
                  but to define it. Quality materials, timeless forms, and
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    "Curated by interior design experts",
            ...
            >
              <div className="grid lg:grid-cols-2">
                <div className="flex flex-col justify-center gap-6 p-10 md:p-14">
                  ...
                  >
                    Handpicked furniture from our most-loved collections — now
                    at our best prices. While stocks last.
                  </p>
                  <Link
                    href="/shop"
        ...
        <section className="border-t border-[#e4ddd3] bg-white py-20 text-center">
          <div className={C}>
            ...
            <p className="mx-auto mb-8 max-w-md text-sm leading-7 text-[#7a7065]">
              Join 10,000+ subscribers who get weekly drops, member-only deals,
            ...
            <p className="mt-4 text-[11px] text-[#b0a89e]">
