...
const sections = [
  {
    ...
    content: (
      <>
        <p className="text-slate-600 dark:text-slate-300">We may collect the following types of personal information:</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-slate-600 dark:text-slate-300">We use personal information for the following purposes:</p>
        <ul className="mt-3 space-y-2">
          {[
  ...
  },
  {
    ...
    content: (
      <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
        ...
        disclosure. Please be aware that no data transmission over the Internet or electronic storage system is
        completely secure. We retain personal information as long as necessary to fulfill the purposes outlined in
  ...
  },
  {
    ...
    content: (
      <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
        ...
        website, and we encourage you to review this policy regularly to stay informed about how we protect your data.
      </p>
    ),
  },
]
      ...
      <div className="not-prose mb-8 overflow-hidden rounded-2xl bg-linear-to-br from-cyan-600 to-teal-600 p-7 text-white shadow-lg shadow-cyan-900/20">
        <div className="flex flex-wrap items-center gap-5">
          ...
          <div className="flex-1">
            <p className="text-xs font-bold uppercase tracking-widest opacity-70">AF Home · Data Privacy</p>
            <h2 className="mt-1 text-xl font-bold">Your privacy is our priority.</h2>
            <p className="mt-1 text-sm opacity-80">
              AF Home values the privacy and security of every customer and distributor. Read below to understand how we handle your data.
            </p>
          </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-cyan-200 bg-linear-to-br from-cyan-50 to-teal-50 shadow-sm dark:border-cyan-900/40 dark:from-cyan-950/30 dark:to-teal-950/30">
          <div className="flex flex-wrap items-center justify-between gap-4 px-5 py-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-bold text-slate-900 dark:text-slate-100">Questions about your privacy?</p>
                <p className="mt-0.5 text-xs text-slate-600 dark:text-slate-400">Reach our data privacy team anytime.</p>
              </div>
            </div>
          ...
          <div className="border-t border-cyan-200/60 px-5 py-3 dark:border-cyan-900/30">
            <p className="text-xs text-slate-500 dark:text-slate-400">
              This policy is for reference purposes. Consult a qualified legal professional to ensure compliance with applicable privacy laws and regulations.
            </p>
          </div>
        </div>
      </div>
