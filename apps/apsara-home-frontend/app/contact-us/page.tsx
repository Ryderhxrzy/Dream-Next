      ...
      <div className="bg-linear-to-br from-sky-500 to-cyan-600 text-white">
        <div className="container mx-auto px-4 py-10 md:py-14">
          <nav className="mb-5 flex items-center gap-1.5 text-xs text-white/60">
            <Link href="/shop" className="transition-colors hover:text-white">Home</Link>
            <span>/</span>
          ...
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-xs font-bold uppercase tracking-widest opacity-70">AF Home · Support</p>
                <h1 className="mt-1 text-3xl font-bold tracking-tight md:text-4xl">We&apos;re here to help.</h1>
            ...
            <div className="flex flex-wrap gap-3">
              {quickStats.map((s) => (
                <div key={s.label} className="rounded-xl bg-white/15 px-4 py-2.5 text-center">
        ...
        <div className="grid gap-10 lg:grid-cols-2 xl:gap-14">
          ...
          <div className="space-y-5">
            ...
            <div className="overflow-hidden rounded-2xl border border-sky-200 bg-linear-to-br from-sky-50 to-cyan-50 p-5 dark:border-sky-900/40 dark:from-sky-950/30 dark:to-cyan-950/30">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-900 dark:text-slate-100">Send us a message</h2>
                  <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                    Tell us what you need and we&apos;ll reply with the best next step. For urgent concerns, call a branch directly.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900/60">
              <div className="flex items-center gap-3 border-b border-slate-100 bg-slate-50/80 px-5 py-4 dark:border-slate-800 dark:bg-slate-800/60">
                ...
                <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">Direct Support Contacts</h3>
              </div>
              <div className="divide-y divide-slate-100 dark:divide-slate-800">
                <div className="px-5 py-4">
                  <p className="mb-2 text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">General Support</p>
                  <a href="mailto:afhome.team@gmail.com" className="flex items-center gap-2.5 text-sm font-medium text-slate-700 transition-colors hover:text-sky-600 dark:text-slate-300 dark:hover:text-sky-400">
                    <Mail className="h-4 w-4 shrink-0 text-sky-500" />
                    afhome.team@gmail.com
                  </a>
                  <p className="mt-1.5 text-xs text-slate-400 dark:text-slate-500">We typically respond within 24 hours.</p>
                </div>
                <div className="px-5 py-4">
                  <p className="mb-2 text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Interior Projects &amp; Business</p>
                  <div className="space-y-2">
                    <a href="mailto:corpsol.apsara@gmail.com" className="flex items-center gap-2.5 text-sm font-medium text-slate-700 transition-colors hover:text-sky-600 dark:text-slate-300 dark:hover:text-sky-400">
                      <Mail className="h-4 w-4 shrink-0 text-sky-500" />
                      corpsol.apsara@gmail.com
                    </a>
                    <a href="tel:09171623056" className="flex items-center gap-2.5 text-sm font-medium text-slate-700 transition-colors hover:text-sky-600 dark:text-slate-300 dark:hover:text-sky-400">
                      <Phone className="h-4 w-4 shrink-0 text-sky-500" />
                      0917 162 3056
                    </a>
                    <a href="tel:09171282559" className="flex items-center gap-2.5 text-sm font-medium text-slate-700 transition-colors hover:text-sky-600 dark:text-slate-300 dark:hover:text-sky-400">
                      <Phone className="h-4 w-4 shrink-0 text-sky-500" />
                      0917 128 2559
                    </a>
                  </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-base font-bold text-slate-900 dark:text-slate-100">Our Branches</h2>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-bold text-slate-800 dark:text-slate-100">{branch.name}</p>
                      <p className="text-xs font-semibold text-sky-600 dark:text-sky-400">{branch.label}</p>
                    </div>
                  </div>
