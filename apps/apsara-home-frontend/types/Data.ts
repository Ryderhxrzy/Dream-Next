...
export const MOCK_ORDERS: Order[] = [
  ...
  },
  {
    ...
    items: [
      {
        id: 4,
        name: "Sarah Corner L-Shaped Sofa",
  ...
  },
  {
    ...
    items: [
      {
        id: 7,
        name: "TV Rack Cabinet",
        image: "/Images/HeroSection/tv_racks.jpg",
        quantity: 1,
        price: 12500,
      },
    ],
