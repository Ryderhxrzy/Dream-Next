  ...
  return (
    <section id="projects" className="bg-white py-24 lg:py-36">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              <Link href="/projects" className="group relative block h-full overflow-hidden rounded-2xl">
                ...
                <div className={`relative w-full overflow-hidden ${aspectConfig[index] ?? aspectConfig[index % aspectConfig.length]}`}>
                  ...
                  <div className="absolute top-4 right-4 flex h-9 w-9 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm border border-white/30">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 lg:p-6">
                    ...
                    <h3 className="mt-1.5 text-base font-medium leading-snug text-white lg:text-lg">
                      {project.title}
                    </h3>
        ...
        {/* Bottom strip */}
        <FadeUp delay={0.2} className="mt-10 flex items-center justify-between border-t border-[var(--border)] pt-8">
          <p className="text-sm text-[var(--muted)]">
            Showing <span className="font-medium text-[var(--foreground)]">{projects.length}</span> of our featured projects
          </p>
          <Link
            href="/projects"
