    ...
    <div className="w-full max-w-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            className="h-11 border-zinc-200 bg-zinc-50 text-zinc-900 placeholder:text-zinc-400 focus-visible:ring-zinc-900"
            required
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <Input
              ...
              className="h-11 border-zinc-200 bg-zinc-50 pr-11 text-zinc-900 placeholder:text-zinc-400 focus-visible:ring-zinc-900"
              required
            />
            <button
              type="button"
        ...
        <Button
          type="submit"
          className="mt-1 h-11 w-full rounded-lg bg-zinc-950 font-semibold text-white transition-colors hover:bg-zinc-800"
          disabled={loading}
        >
          {loading ? (
      ...
      <p className="text-center text-sm text-zinc-500">
        ...
        <a
          ...
          className="font-semibold text-zinc-900 underline decoration-zinc-300 underline-offset-4 transition-colors hover:decoration-zinc-900"
        >
          AFHome
        </a>{" "}
